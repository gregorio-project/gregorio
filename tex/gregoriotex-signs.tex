...
\newcount\gre@count@barshiftaftermora
\gre@count@barshiftaftermora=3

\def\gresetbarshiftaftermora#1{%
  \IfStrEq{#1}{always}%
    {\gre@count@barshiftaftermora=3}%
    {\IfStrEq{#1}{notextonly}%
      {\gre@count@barshiftaftermora=2}%
      {\IfStrEq{#1}{insideonly}%
        {\gre@count@barshiftaftermora=1}%
        {\IfStrEq{#1}{never}%
          {\gre@count@barshiftaftermora=0}%
...
\def\gre@writebar#1#2#3#4{%
  ...
  \ifgre@lastispunctum%
    \ifcase\gre@count@barshiftaftermora\or %
      \ifcase #2\or %
