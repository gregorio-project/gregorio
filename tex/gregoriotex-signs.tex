...
\def\grechoralsignstyle#1{#1}

% quite simple function: #1 is the height, #2 is the string
\def\grechoralsign#1#2{%
...
% a set of macros for the default characters
...
\def\greflat#1#2{%
  \grealteration{#1}{\greflatchar}{\greflatholechar}%
  \relax%
}
...
\def\grenatural#1#2{%
  \grealteration{#1}{\grenaturalchar}{\grenaturalholechar}%
  \relax%
}
...
\def\gresharp#1#2{%
  \grealteration{#1}{\gresharpchar}{\gresharpholechar}%
  \relax%
}
