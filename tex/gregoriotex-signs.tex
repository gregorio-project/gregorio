...
\def\gresetlinesclef#1#2#3#4{%
  \grelocalleftbox{%
    ...
    \ifnum\greremoveclefcount=0\relax %
      \hbox{\gretypekey{#1}{#2}{0}{#3}{#4}\hskip\gre@afterclefnospace}%
    \else %
...
\def\grechangeclef#1#2#3#4{%
  ...
  \else %
    ...
    \grehskip -\gre@spacearoundclefbars %
  \fi %
...
\def\gremanualcusto#1{%
  \kern\gre@spacebeforecusto\grecusto{#1}%
}
...
\def\grewritebar#1#2#3{%
  ...
  \ifcase#1 % 0 : virgula
    \ifnum#2=1\relax %
      \grehskip\gre@spacearoundsmallbar %
      \grenobreak %
    \fi %
  ...
  \or % 4 : finalis
    \ifnum#2=1\relax %
      \grehskip\gre@spacearoundfinalis %
      \grenobreak %
    \fi %
  ...
  \or % 5 : finalis
    \ifnum#2=1\relax %
      \grehskip\gre@spacebeforefinalfinalis %
      \grenobreak %
    \fi %
    \setbox\GreTempwidth=\hbox{\gredivisiofinalissymbol}%
    #3\relax %
