...
\def\greadditionaltopcustolineend{%
  ...
  \hbox to 0pt{%
    \gre@format@additionalstafflines %
    ...
    \hss %
    \endgre@format@additionalstafflines%
  }%
  \relax %
}%
...
\def\grelowchoralsign#1#2#3{%
  ...
  \fi %
  \raise\gre@dimen@glyphraisevalue\hbox{{\gre@format@lowchoralsign\grelowchoralsignstyle{#2}\endgre@format@lowchoralsign}}%
  \relax %
}%

\def\grehighchoralsign#1#2#3{%
  \grenobreak %
  \grevepisemusorrare{#1}{#3}{}{3}{{\gre@format@highchoralsign\grehighchoralsignstyle{#2}\endgre@format@highchoralsign}}%
  %\grehepisorline{#1}{#3}{0}{4}{{\gre@format@highchoralsign\grehighchoralsignstyle{#2}\endgre@format@highchoralsign}}
  \relax %
}%
