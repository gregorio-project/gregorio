...
\gdef\gre@fontchar@curlybrace{\gregoriofont\gre@char@curlybrace}%
\gdef\gre@fontchar@brace{\gregoriofont\gre@char@brace}%
\gdef\gre@fontchar@underbrace{\gregoriofont\gre@char@bracedown}%
...
\def\GreHighChoralSign#1#2#3{%
  \GreNoBreak %
  \gre@vepisemusorrare{#1}{#3}{}{3}{{\gre@style@highchoralsign\grehighchoralsignstyle{#2}\endgre@style@highchoralsign}}%
  %\gre@hepisorline{#1}{#3}{0}{4}{{\gre@style@highchoralsign\grehighchoralsignstyle{#2}\endgre@style@highchoralsign}}
  \relax %
}%
...
\def\GreBarVEpisemus#1{%
  \gre@vepisemusorrare{\gre@pitch@c}{#1}{\gre@char@vepisemus}{1}{}%
  \relax %
}%
...
\def\gre@fontchar@punctumcavum{\gregoriofont\gre@char@punctumcavum}%
\def\gre@fontchar@lineapunctumcavum{\gregoriofont\gre@char@lineapunctumcavum}%
\def\gre@fontchar@punctumcavumhole{\gregoriofont\gre@char@punctumcavumhole}%
\def\gre@fontchar@lineapunctumcavumhole{\gregoriofont\gre@char@lineapunctumcavumhole}%
...
\def\GrePunctumCavum#1#2#3#4#5#6{%
  \setbox\gre@box@temp@width=\hbox{\gre@fontchar@punctumcavum}%
  \global\gre@dimen@lastglyphwidth=\wd\gre@box@temp@width %
  ...
  \gre@calculate@glyphraisevalue{#1}{0}%
  \ifgre@hidepclines%
    \gre@fillhole{\gre@fontchar@punctumcavumhole}%
  \fi %
  \GreGlyph{\gre@fontchar@punctumcavum}{#1}{#2}{#3}{}{#5}{#6}%
  \relax %
}%

\def\GreLineaPunctumCavum#1#2#3#4#5#6{%
  \setbox\gre@box@temp@width=\hbox{\gre@fontchar@lineapunctumcavum}%
  \global\gre@dimen@lastglyphwidth=\wd\gre@box@temp@width %
  \gre@skip@temp@four = \gre@dimen@lastglyphwidth%
  \kern\gre@skip@temp@four %
  #4\relax %
  ...
  \gre@calculate@glyphraisevalue{#1}{0}%
  \ifgre@hidepclines %
    \gre@fillhole{\gre@fontchar@lineapunctumcavumhole}%
  \fi %
  \GreGlyph{\gre@fontchar@lineapunctumcavum}{#1}{#2}{#3}{}{#5}{#6}%
  \relax %
}%
