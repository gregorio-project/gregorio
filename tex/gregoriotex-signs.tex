...
\ifcase#2 %
\or%
\calculateglyphraisevalue{c}{0}{0}%
\or%
\calculateglyphraisevalue{e}{0}{0}%
\or%
\calculateglyphraisevalue{g}{0}{0}%
\or%
\calculateglyphraisevalue{i}{0}{0}%
\fi%
...
\setbox\Leftbox=\hbox{\raise\glyphraisevalue\hbox{\gregorianfont \char 2}}%
\or%
...
\def\setcusto#1{%
\calculateglyphraisevalue{#1}{0}{0}%
\localrightbox{%
...
\fi %
\calculateglyphraisevalue{#1}{4}{0}%
...
\hskip\spacebeforesigns%
\calculateglyphraisevalue{#1}{2}{0}%
...
\def\vepisemus#1#2{%
\calculateglyphraisevalue{#1}{3}{1}%
\ifcase#2 %
%case 0
...
\calculateglyphraisevalue{#1}{1}{0}%
\ifcase#2 %
%case 0
...
\penalty 7000 %
\fi %
\calculateglyphraisevalue{g}{0}{0}% bar glyphs are made to be at this height
