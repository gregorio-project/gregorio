...
\def\gre@get@unkern@aftermora#1{%
  ...
  \ifnum #1=1%
    \global\gre@skip@temp@four=\glueexpr -\wd\gre@box@temp@width - \gre@space@skip@spacebeforesigns + \gre@space@skip@moraadjustment\relax %
  \else %
    \global\gre@skip@temp@four=\glueexpr -\wd\gre@box@temp@width - \gre@space@skip@spacebeforesigns + \gre@space@skip@moraadjustmentbar\relax %
  \fi %
  \relax %
}
