...
\gre@declarefileversion{gregoriotex-signs.tex}{4.1.0-beta1}% GREGORIO_VERSION
...
\def\gre@get@unkern@aftermora#1{%
  \ifdim\gre@dimen@widthmora=0pt\relax %
    \setbox\gre@box@temp@width=\hbox{\gre@font@music\gre@fontchar@punctummora}%
    \global\gre@dimen@widthmora=\wd\gre@box@temp@width %
  \fi %
  \ifnum #1=1%
    \global\gre@skip@temp@four=\glueexpr - \gre@dimen@widthmora - \gre@space@skip@spacebeforesigns + \gre@space@skip@moraadjustment\relax %
  \else %
    \global\gre@skip@temp@four=\glueexpr - \gre@dimen@widthmora - \gre@space@skip@spacebeforesigns + \gre@space@skip@moraadjustmentbar\relax %
  \fi %
  \relax %
}
