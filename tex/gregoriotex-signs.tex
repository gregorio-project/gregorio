...
\gdef\grecurlybracechar{\gregoriofont\gregoriochar\gre@char@curlybrace}%
\gdef\grebracechar{\gregoriofont\gregoriochar\gre@char@brace}%
...
\def\greovercurlybrace#1#2#3#4#5{%
  ...
  \hbox to 0pt{%
    ...
    \ifnum#2=1\relax %
      ...
      \raise\gre@dimen@glyphraisevalue\hbox{%
        \gregoriofont\gregoriochar\gre@char@accentus\relax %
      }%
      \hss %
    \fi %
  }%
...
\def\grepunctummora#1#2#3#4{%
  ...
  \or %
    ...
    \setbox\GreTempwidth=\hbox{\gregoriofont \gregoriochar\gre@char@flexus}%
    \gre@dimen@temp@five=\wd\GreTempwidth %
    \setbox\GreTempwidth=\hbox{\gregoriofont \gregoriochar\gre@char@punctum}%
...
\def\grelinea#1#2#3{%
  \greglyph{\gregoriochar\gre@char@linea}{#1}{#2}{#3}{}{}%
  \relax %
}%
...
\def\grevepisemusorrareaux#1#2#3#4#5#6#7{%
  ...
  \or % rare sign
    \setbox\GreTempsign=\hbox{\gregoriofont \gregoriochar#5}%
  \or % choral sign
...
\def\grevepisemusorrare#1#2#3#4#5{%
  ...
  \ifcase#2 %
    %case 0
    \grevepisemusorrareaux{0}{\gregoriochar\gre@char@punctum}{1}{0}{#3}{#4}{#5}%
  \or%
    %case 1
    \grevepisemusorrareaux{0}{\gregoriochar\gre@char@smallpunctum}{1}{0}{#3}{#4}{#5}%
  \or%
    %case 2
    % a kind of flexus, it has the good width
    \grevepisemusorrareaux{\gregoriochar\gre@char@flexusalt}{\gregoriochar\gre@char@punctum}{2}{0}{#3}{#4}{#5}%
  \or%
    %case 3
    ...
    \grevepisemusorrareaux{0}{\gregoriochar\gre@char@flexusdeminutus}{1}{0}{#3}{#4}{#5}%
  \or%
    %case 4
    % is a torculus, it has the good width
    \grevepisemusorrareaux{\gregoriochar\gre@char@torculus}{\gregoriochar\gre@char@punctum}{2}{0}{#3}{#4}{#5}%
  \or%
    %case 5
    % is a torculus deminutus, it has the good width
    \grevepisemusorrareaux{\gregoriochar\gre@char@torculusdeminutus}{\gregoriochar\gre@char@punctum}{2}{0}{#3}{#4}{#5}%
  \or%
    %case 6
    \grevepisemusorrareaux{0}{\gregoriochar\gre@char@punctum}{0}{0}{#3}{#4}{#5}%
  \or%
    %case 7
    \grevepisemusorrareaux{0}{\gregoriochar\gre@char@smallpunctum}{0}{0}{#3}{#4}{#5}%
  \or%
  ...
  \or\or\or %
    %case 12
    \grevepisemusorrareaux{0}{\gregoriochar\gre@char@punctuminclinatum}{0}{30\the\grefactor }{#3}{#4}{#5}%
  \or%
    %case 13
    \grevepisemusorrareaux{0}{\gregoriochar\gre@char@punctuminclinatumdem}{0}{0}{#3}{#4}{#5}%
  \or%
    %case 14
    \grevepisemusorrareaux{0}{\gregoriochar\gre@char@stropha}{0}{0}{#3}{#4}{#5}%
  \or%
    %case 15
    \grevepisemusorrareaux{0}{\gregoriochar\gre@char@quilisma}{0}{0}{#3}{#4}{#5}%
  \or%
    %case 16
    \grevepisemusorrareaux{0}{\gregoriochar\gre@char@oriscus}{0}{0}{#3}{#4}{#5}%
  \or%
    %case 17
    \grevepisemusorrareaux{\gregoriochar\gre@char@flexusaltone}{\gregoriochar\gre@char@punctum}{2}{0}{#3}{#4}{#5}%
  \or%
    %case 18
    \grevepisemusorrareaux{0}{\gregoriochar\gre@char@peshigh}{1}{-30\the\grefactor}{#3}{#4}{#5}%
  \or%
    %case 19
    \grevepisemusorrareaux{0}{\gregoriochar\gre@char@oriscusauctus}{0}{0}{#3}{#4}{#5}%
  \or%
    %case 20
    \grevepisemusorrareaux{0}{\gregoriochar\gre@char@quilisma}{0}{0}{#3}{#4}{#5}%
  \or%
    ...
    \grevepisemusorrareaux{\gregoriochar\gre@char@flexusalt}{\gregoriochar\gre@char@punctum}{3}{0}{#3}{#4}{#5}%
  \or%
    %case 22 
    % 5633 is a flexus without bar with ambitus of 1
    \grevepisemusorrareaux{\gregoriochar\gre@char@flexusaltone}{\gregoriochar\gre@char@punctum}{3}{0}{#3}{#4}{#5}%
  \or%
    %case 23
    \grevepisemusorrareaux{\gregoriochar\gre@char@pesinitauctus}{\gregoriochar\gre@char@punctum}{3}{0}{#3}{#4}{#5}%
  \or%
    %case 24
    \grevepisemusorrareaux{0}{\gregoriochar\gre@char@lineapunctum}{1}{0}{#3}{#4}{#5}%
  \or%
    %case 25
    \grevepisemusorrareaux{0}{\gregoriochar\gre@char@divisiominima}{1}{0}{#3}{#4}{#5}%
  \or%
    %case 26
    \grevepisemusorrareaux{0}{\gregoriochar\gre@char@virgula}{1}{0}{#3}{#4}{#5}%
  \or%
    %case 27
...
\def\grehepisorlineaux#1#2#3#4{%
  ...
  \setbox\GreTempsign=\hbox{\gregoriofont\gregoriochar{#2}}%
  % we set tempwidth to half a punctum malus half the sign width, so that the centers are aligned
  \gre@dimen@temp@two=\wd\GreTempsign %
...
\def\grehepisorline#1#2#3#4{%
  ...
  \ifcase#2 %
    %case 0
    \grehepisorlineaux{\gregoriochar\gre@char@punctum}{\gre@char@he@punctum}{1}{#4}%
  \or%
    %case 1
    \grehepisorlineaux{\gregoriochar\gre@char@smallpunctum}{\gre@char@he@initio}{1}{#4}%
  \or%
    %case 2
    % a kind of flexus, it has the good width
    \grehepisorlineaux{\gregoriochar\gre@char@flexusalt}{\gre@char@he@punctum}{1}{#4}%
  \or%
    %case 3
    % in order to go to the good place, we first make a kern of - the glyph before deminutus, which has the same width as a standard flexus deminutus
    \grehepisorlineaux{\gregoriochar\gre@char@flexusdeminutus}{\gre@char@he@punctum}{1}{#4}%
  \or%
    %case 4
    % a torculus, it has the good width
    \grehepisorlineaux{\gregoriochar\gre@char@torculus}{\gre@char@he@punctum}{1}{#4}%
  \or%
    %case 5
    % \char 29190 is a torculus deminutus, it has the good width
    \grehepisorlineaux{\gregoriochar\gre@char@torculusdeminutus}{\gre@char@he@punctum}{1}{#4}%
  \or%
    %case 6
  ...
  \or %
    ...
    \ifcase#3%
    \or%
      \grehepisorlineaux{\gregoriochar\gre@char@porrectus@one}{\gre@char@he@porrectusfl@one}{1}{#4}%
    \or%
      \grehepisorlineaux{\gregoriochar\gre@char@porrectus@two}{\gre@char@he@porrectusfl@two}{1}{#4}%
    \or%
      \grehepisorlineaux{\gregoriochar\gre@char@porrectus@three}{\gre@char@he@porrectusfl@three}{1}{#4}%
    \or%
      \grehepisorlineaux{\gregoriochar\gre@char@porrectus@four}{\gre@char@he@porrectusfl@four}{1}{#4}%
    \or%
      \grehepisorlineaux{\gregoriochar\gre@char@porrectus@five}{\gre@char@he@porrectusfl@five}{1}{#4}%
    \fi%
  \or%
    %case 12
    \grehepisorlineaux{\gregoriochar\gre@char@punctuminclinatum}{\gre@char@he@inclinatum}{1}{#4}%
  \or%
    %case 13
    \grehepisorlineaux{\gregoriochar\gre@char@punctuminclinatumdem}{\gre@char@he@inclinatumdem}{1}{#4}%
  \or%
    %case 14
    \grehepisorlineaux{\gregoriochar\gre@char@stropha}{\gre@char@he@stropha}{1}{#4}%
  \or%
    %case 15
    \grehepisorlineaux{\gregoriochar\gre@char@quilisma}{\gre@char@he@quilisma}{1}{#4}%
  \or%
    %case 16
    \grehepisorlineaux{\gregoriochar\gre@char@oriscus}{\gre@char@he@oriscus}{1}{#4}%
  \or%
    %case 17
    \grehepisorlineaux{\gregoriochar\gre@char@flexusaltone}{\gre@char@he@punctum}{1}{#4}%
  \or %
    %case 18
    \grehepisorlineaux{\gregoriochar\gre@char@peshigh}{\gre@char@he@smallpunctum}{1}{#4}%
  \or %
    %case 19
  ...
  \or %
    ...
    \ifcase#3%
    \or%
      \grehepisorlineaux{\gregoriochar\gre@char@porrectus@one}{\gre@char@he@punctum}{1}{#4}%
    \or%
      \grehepisorlineaux{\gregoriochar\gre@char@porrectus@two}{\gre@char@he@punctum}{1}{#4}%
    \or%
      \grehepisorlineaux{\gregoriochar\gre@char@porrectus@three}{\gre@char@he@punctum}{1}{#4}%
    \or%
      \grehepisorlineaux{\gregoriochar\gre@char@porrectus@four}{\gre@char@he@punctum}{1}{#4}%
    \or%
      \grehepisorlineaux{\gregoriochar\gre@char@porrectus@five}{\gre@char@he@punctum}{1}{#4}%
    \fi%
  \or %
    %case 22
    \ifcase#3%
  ...
  \or%
    %case 24
    \grehepisorlineaux{\gregoriochar\gre@char@pesinitauctusone}{\gre@char@he@punctum}{1}{#4}%the episemus is not quite long enough so I assumed a different width for now...
  \fi%
  \relax%
}%
...
\def\grehepisemusbridge#1#2#3{%
  \ifnum\greaddhepisemusbridges=1\relax %
    \gre@calculate@glyphraisevalue{#1}{9}%
    \raise\gre@dimen@glyphraisevalue\hbox to 0pt{\gregoriofont\gregoriochar\gre@char@he@punctum\hss}%
  \fi %
  \relax %
}%
...
\def\grewritebar#1#2#3{%
  ...
  \ifcase#1 % 0 : virgula
    \ifnum#2=1\relax %
      ...
      \grenobreak %
    \fi %
    \setbox\GreTempwidth=\hbox{\gregoriofont \gregoriochar\gre@char@virgula}%
    \raise\gre@dimen@glyphraisevalue\hbox{\gregoriofont \gregoriochar\gre@char@virgula}%
    #3\relax %
    \ifnum#2=1\relax %
      \gre@skip@temp@four = \gre@skip@spacearoundsmallbar%
      \grehskip\gre@skip@temp@four %
  ...
  \or % 1 : minima
    \ifnum#2=1\relax %
      ...
      \grenobreak %
    \fi %
    \setbox\GreTempwidth=\hbox{\gregoriofont \gregoriochar\gre@char@divisiominima}%
    \raise\gre@dimen@glyphraisevalue\hbox{\gregoriofont \gregoriochar\gre@char@divisiominima}%
    #3\relax %
    \ifnum#2=1\relax %
      \gre@skip@temp@four = \gre@skip@spacearoundsmallbar%
      \grehskip\gre@skip@temp@four %
  ...
  \or % 2 : minor
    \ifnum#2=1\relax %
      ...
      \grenobreak %
    \fi %
    \setbox\GreTempwidth=\hbox{\gregoriofont \gregoriochar\gre@char@divisiominor}%
    \raise\gre@dimen@glyphraisevalue\hbox{\gregoriofont \gregoriochar\gre@char@divisiominor}%
    #3\relax %
    \ifnum#2=1\relax %
      \gre@skip@temp@four = \gre@skip@spacearoundminor%
      \grehskip\gre@skip@temp@four %
  ...
  \or % 3 : maior
    \ifnum#2=1\relax %
      ...
      \grenobreak %
    \fi %
    \setbox\GreTempwidth=\hbox{\gregoriofont \gregoriochar\gre@char@divisiomaior}%
  ...
  \or % 6 : dominican bar 1
    ...
    \ifnum#2=1\relax %
      ...
      \grenobreak %
    \fi %
    \setbox\GreTempwidth=\hbox{\gregoriofont \gregoriochar\gre@char@divisiodominican}%
    \raise\gre@dimen@glyphraisevalue\hbox{\gregoriofont \gregoriochar\gre@char@divisiodominican}%
    #3\relax %
    \ifnum#2=1\relax %
      \gre@skip@temp@four = \gre@skip@spacearoundminor%
      \grehskip\gre@skip@temp@four %
  ...
  \or % 7 : dominican bar 2
    ...
    \ifnum#2=1\relax %
      ...
      \grenobreak %
    \fi %
    \setbox\GreTempwidth=\hbox{\gregoriofont \gregoriochar\gre@char@divisiodominicanalt}%
    \raise\gre@dimen@glyphraisevalue\hbox{\gregoriofont \gregoriochar\gre@char@divisiodominicanalt}%
    #3\relax %
    \ifnum#2=1\relax %
      \gre@skip@temp@four = \gre@skip@spacearoundminor%
      \grehskip\gre@skip@temp@four %
...
\def\gredivisiomaiorsymbol{%
  \ifnum\gre@stafflinefactor=17\relax %
    %\gre@calculate@glyphraisevalue{g}{0}% bar glyphs are made to be at this height
    \raise\gre@dimen@glyphraisevalue\hbox{\gregoriofont \gregoriochar\gre@char@divisiomaior}%
  \else %
    \setbox\GreTempwidth=\hbox{\gregoriofont \gregoriochar\gre@char@divisiomaior}%
...
\gdef\grepunctumcavumchar{\gregoriofont\gregoriochar\gre@char@punctumcavumalt}%
\gdef\grelineapunctumcavumchar{\gregoriofont\gregoriochar\gre@char@lineapunctumcavumalt}%
\gdef\grepunctumcavumholechar{\gregoriofont\gregoriochar\gre@char@punctumcavumholealt}%
\gdef\grelineapunctumcavumholechar{\gregoriofont\gregoriochar\gre@char@lineapunctumcavumholealt}%
\relax %
}%

\def\UseNormalPunctumCavum{%
\gdef\grepunctumcavumchar{\gregoriofont\gregoriochar\gre@char@punctumcavum}%
\gdef\grelineapunctumcavumchar{\gregoriofont\gregoriochar\gre@char@lineapunctumcavum}%
\gdef\grepunctumcavumholechar{\gregoriofont\gregoriochar\gre@char@punctumcavumhole}%
\gdef\grelineapunctumcavumholechar{\gregoriofont\gregoriochar\gre@char@lineapunctumcavumhole}%
\relax %
}%
