...
\def\grelinea#1#2#3{%
  \greglyph{\gre@char\gre@char@linea}{#1}{#2}{#3}{}{}%
  \relax %
}%
...
\def\grevepisemusorrare#1#2#3#4#5{%
  ...
  \ifcase#2 %
    %case 0
    \grevepisemusorrareaux{0}{\gre@char\gre@char@punctum}{1}{0}{#3}{#4}{#5}%
  \or%
    %case 1
    \grevepisemusorrareaux{0}{\gre@char\gre@char@smallpunctum}{1}{0}{#3}{#4}{#5}%
  \or%
    %case 2
    % a kind of flexus, it has the good width
    \grevepisemusorrareaux{\gre@char\gre@char@flexusalt}{\gre@char\gre@char@punctum}{2}{0}{#3}{#4}{#5}%
  \or%
    %case 3
    ...
    \grevepisemusorrareaux{0}{\gre@char\gre@char@flexusdeminutus}{1}{0}{#3}{#4}{#5}%
  \or%
    %case 4
    % is a torculus, it has the good width
    \grevepisemusorrareaux{\gre@char\gre@char@torculus}{\gre@char\gre@char@punctum}{2}{0}{#3}{#4}{#5}%
  \or%
    %case 5
    % is a torculus deminutus, it has the good width
    \grevepisemusorrareaux{\gre@char\gre@char@torculusdeminutus}{\gre@char\gre@char@punctum}{2}{0}{#3}{#4}{#5}%
  \or%
    %case 6
    \grevepisemusorrareaux{0}{\gre@char\gre@char@punctum}{0}{0}{#3}{#4}{#5}%
  \or%
    %case 7
    \grevepisemusorrareaux{0}{\gre@char\gre@char@smallpunctum}{0}{0}{#3}{#4}{#5}%
  \or%
  ...
  \or\or\or %
    %case 12
    \grevepisemusorrareaux{0}{\gre@char\gre@char@punctuminclinatum}{0}{30\the\grefactor }{#3}{#4}{#5}%
  \or%
    %case 13
    \grevepisemusorrareaux{0}{\gre@char\gre@char@punctuminclinatumdem}{0}{0}{#3}{#4}{#5}%
  \or%
    %case 14
    \grevepisemusorrareaux{0}{\gre@char\gre@char@stropha}{0}{0}{#3}{#4}{#5}%
  \or%
    %case 15
    \grevepisemusorrareaux{0}{\gre@char\gre@char@quilisma}{0}{0}{#3}{#4}{#5}%
  \or%
    %case 16
    \grevepisemusorrareaux{0}{\gre@char\gre@char@oriscus}{0}{0}{#3}{#4}{#5}%
  \or%
    %case 17
    \grevepisemusorrareaux{\gre@char\gre@char@flexusaltone}{\gre@char\gre@char@punctum}{2}{0}{#3}{#4}{#5}%
  \or%
    %case 18
    \grevepisemusorrareaux{0}{\gre@char\gre@char@peshigh}{1}{-30\the\grefactor}{#3}{#4}{#5}%
  \or%
    %case 19
    \grevepisemusorrareaux{0}{\gre@char\gre@char@oriscusauctus}{0}{0}{#3}{#4}{#5}%
  \or%
    %case 20
    \grevepisemusorrareaux{0}{\gre@char\gre@char@quilisma}{0}{0}{#3}{#4}{#5}%
  \or%
    ...
    \grevepisemusorrareaux{\gre@char\gre@char@flexusalt}{\gre@char\gre@char@punctum}{3}{0}{#3}{#4}{#5}%
  \or%
    %case 22 
    % 5633 is a flexus without bar with ambitus of 1
    \grevepisemusorrareaux{\gre@char\gre@char@flexusaltone}{\gre@char\gre@char@punctum}{3}{0}{#3}{#4}{#5}%
  \or%
    %case 23
    \grevepisemusorrareaux{\gre@char\gre@char@pesinitauctus}{\gre@char\gre@char@punctum}{3}{0}{#3}{#4}{#5}%
  \or%
    %case 24
    \grevepisemusorrareaux{0}{\gre@char\gre@char@lineapunctum}{1}{0}{#3}{#4}{#5}%
  \or%
    %case 25
    \grevepisemusorrareaux{0}{\gre@char\gre@char@divisiominima}{1}{0}{#3}{#4}{#5}%
  \or%
    %case 26
    \grevepisemusorrareaux{0}{\gre@char\gre@char@virgula}{1}{0}{#3}{#4}{#5}%
  \or%
    %case 27
...
\def\grehepisorline#1#2#3#4{%
  ...
  \ifcase#2 %
    %case 0
    \grehepisorlineaux{\gre@char\gre@char@punctum}{\gre@char@he@punctum}{1}{#4}%
  \or%
    %case 1
    \grehepisorlineaux{\gre@char\gre@char@smallpunctum}{\gre@char@he@initio}{1}{#4}%
  \or%
    %case 2
    % a kind of flexus, it has the good width
    \grehepisorlineaux{\gre@char\gre@char@flexusalt}{\gre@char@he@punctum}{1}{#4}%
  \or%
    %case 3
    % in order to go to the good place, we first make a kern of - the glyph before deminutus, which has the same width as a standard flexus deminutus
    \grehepisorlineaux{\gre@char\gre@char@flexusdeminutus}{\gre@char@he@punctum}{1}{#4}%
  \or%
    %case 4
    % a torculus, it has the good width
    \grehepisorlineaux{\gre@char\gre@char@torculus}{\gre@char@he@punctum}{1}{#4}%
  \or%
    %case 5
    % \char 29190 is a torculus deminutus, it has the good width
    \grehepisorlineaux{\gre@char\gre@char@torculusdeminutus}{\gre@char@he@punctum}{1}{#4}%
  \or%
    %case 6
  ...
  \or %
    ...
    \ifcase#3%
    \or%
      \grehepisorlineaux{\gre@char\gre@char@porrectus@one}{\gre@char@he@porrectusfl@one}{1}{#4}%
    \or%
      \grehepisorlineaux{\gre@char\gre@char@porrectus@two}{\gre@char@he@porrectusfl@two}{1}{#4}%
    \or%
      \grehepisorlineaux{\gre@char\gre@char@porrectus@three}{\gre@char@he@porrectusfl@three}{1}{#4}%
    \or%
      \grehepisorlineaux{\gre@char\gre@char@porrectus@four}{\gre@char@he@porrectusfl@four}{1}{#4}%
    \or%
      \grehepisorlineaux{\gre@char\gre@char@porrectus@five}{\gre@char@he@porrectusfl@five}{1}{#4}%
    \fi%
  \or%
    %case 12
    \grehepisorlineaux{\gre@char\gre@char@punctuminclinatum}{\gre@char@he@inclinatum}{1}{#4}%
  \or%
    %case 13
    \grehepisorlineaux{\gre@char\gre@char@punctuminclinatumdem}{\gre@char@he@inclinatumdem}{1}{#4}%
  \or%
    %case 14
    \grehepisorlineaux{\gre@char\gre@char@stropha}{\gre@char@he@stropha}{1}{#4}%
  \or%
    %case 15
    \grehepisorlineaux{\gre@char\gre@char@quilisma}{\gre@char@he@quilisma}{1}{#4}%
  \or%
    %case 16
    \grehepisorlineaux{\gre@char\gre@char@oriscus}{\gre@char@he@oriscus}{1}{#4}%
  \or%
    %case 17
    \grehepisorlineaux{\gre@char\gre@char@flexusaltone}{\gre@char@he@punctum}{1}{#4}%
  \or %
    %case 18
    \grehepisorlineaux{\gre@char\gre@char@peshigh}{\gre@char@he@smallpunctum}{1}{#4}%
  \or %
    %case 19
  ...
  \or %
    ...
    \ifcase#3%
    \or%
      \grehepisorlineaux{\gre@char\gre@char@porrectus@one}{\gre@char@he@punctum}{1}{#4}%
    \or%
      \grehepisorlineaux{\gre@char\gre@char@porrectus@two}{\gre@char@he@punctum}{1}{#4}%
    \or%
      \grehepisorlineaux{\gre@char\gre@char@porrectus@three}{\gre@char@he@punctum}{1}{#4}%
    \or%
      \grehepisorlineaux{\gre@char\gre@char@porrectus@four}{\gre@char@he@punctum}{1}{#4}%
    \or%
      \grehepisorlineaux{\gre@char\gre@char@porrectus@five}{\gre@char@he@punctum}{1}{#4}%
    \fi%
  \or %
    %case 22
    \ifcase#3%
  ...
  \or%
    %case 24
    \grehepisorlineaux{\gre@char\gre@char@pesinitauctusone}{\gre@char@he@punctum}{1}{#4}%the episemus is not quite long enough so I assumed a different width for now...
  \fi%
  \relax%
}%
