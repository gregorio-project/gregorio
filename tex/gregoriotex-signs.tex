...
\def\grehepisorline#1#2#3#4{{%
  ...
  \or %
    \gre@calculate@glyphraisevalue{#1}{11}%
  \fi %
  \ifcase#3\let\ambitusepisemus=\gre@char@he@punctum%
  \or\let\ambitusepisemus=\gre@char@he@porrectus@one%
  \or\let\ambitusepisemus=\gre@char@he@porrectus@two%
  \or\let\ambitusepisemus=\gre@char@he@porrectus@three%
  \or\let\ambitusepisemus=\gre@char@he@porrectus@four%
  \or\let\ambitusepisemus=\gre@char@he@porrectus@five%
  \fi%
  \ifcase#2 %
    %case 0
  ...
  \or%
    %case 6
    \grehepisorlineaux{0}{\ambitusepisemus}{0}{#4}%
  \or%
    %case 7
  ...
  \or%
    %case 21
    \grehepisorlineaux{\gre@char@leading@punctum@two}{\ambitusepisemus}{3}{#4}%
  \or%
    %case 22
    \grehepisorlineaux{\gre@char@leading@punctum@one}{\ambitusepisemus}{3}{#4}%
  \or%
    %case 23
    \grehepisorlineaux{\gre@char@leading@debilis@one}{\ambitusepisemus}{3}{#4}%
  \or%
    %case 24
  ...
  \or%
    %case 30
    \grehepisorlineaux{\gre@char@leading@quilisma@one}{\ambitusepisemus}{3}{#4}%
  \or%
    %case 31
    \grehepisorlineaux{\gre@char@leading@oriscus@one}{\ambitusepisemus}{3}{#4}%
  \or%
    %case 32
    \grehepisorlineaux{\gre@char@leading@punctum@two}{\ambitusepisemus}{3}{#4}%
  \or%
    %case 33
    \grehepisorlineaux{\gre@char@leading@debilis@two}{\ambitusepisemus}{3}{#4}%
  \or%
    %case 34
    \grehepisorlineaux{\gre@char@leading@quilisma@two}{\ambitusepisemus}{3}{#4}%
  \or%
    %case 35
    \grehepisorlineaux{\gre@char@leading@oriscus@two}{\ambitusepisemus}{3}{#4}%
  \fi%
  \relax%
}}%
