...
\def\grevepisemusorrareaux#1#2#3#4#5#6#7{%
  ...
  % tempwidth is the width of the last glyph
    \advance\gre@dimen@temp@three by -\gre@temp@dimen@two %
  \or%
    \gre@dimen@temp@three=\gre@temp@dimen@two %
  \or%
  ...
  % then we draw the sign
    ...
    \advance\gre@dimen@temp@three by -2\gre@temp@dimen@two %
  \fi %
  \kern\gre@dimen@temp@three%
  \relax%
}%
...
\def\grehepisorlineaux#1#2#3#4{%
  ...
  \else %
    ...
    \kern-\gre@dimen@temp@five %
    \advance\gre@dimen@temp@two by 2\gre@temp@dimen@five %
  \fi %
  \ifcase#4%
    %case of hepisemus
    \raise \gre@dimen@glyphraisevalue \copy\GreTempsign %
...
\def\grealteration#1#2#3#4{%
  ...
  \ifnum#4=0\relax %
    ...
    \ifnum\the\grefirstglyph=1\relax %
      ...
      \global\advance\gre@dimen@notesaligncenter by \gre@skip@alterationspace %
