...
%% 28: the second note of a fused glyph with a first ambitus of one, if the
%%     first note is a punctum
%% 29: idem, if the first note is an initio debilis
%% 30: idem, if the first note is a quilisma
%% 31: idem, if the first note is an oriscus
%% 32: the second note of a fused glyph with a first ambitus of at least two,
%%     if the first note is a punctum
%% 33: idem, if the first note is an initio debilis
%% 34: idem, if the first note is a quilisma
%% 35: idem, if the first note is an oriscus
...
\def\grevepisemusorrare#1#2#3#4#5{%
  ...
  \or%
    ...
    \grevepisemusorrareaux{\gre@char@flexusalt}{\gre@char@punctum}{3}{0}{#3}{#4}{#5}%
  \or%
    %case 22 
    % 5633 is a flexus without bar with ambitus of 1
    \grevepisemusorrareaux{\gre@char@flexusaltone}{\gre@char@punctum}{3}{0}{#3}{#4}{#5}%
  \or%
    %case 23
    \grevepisemusorrareaux{\gre@char@pesinitauctus}{\gre@char@punctum}{3}{0}{#3}{#4}{#5}%
  \or%
    %case 24
  ...
  \or%
    %case 29
    \grevepisemusorrareaux{\gre@char@fuse@debilis@one}{\gre@char@punctum}{3}{0}{#3}{#4}{#5}%
  \or%
    %case 30
  ...
  \or%
    %case 33
    \grevepisemusorrareaux{\gre@char@fuse@debilis@two}{\gre@char@punctum}{3}{0}{#3}{#4}{#5}%
  \or%
    %case 34
...
\def\grehepisorline#1#2#3#4{{%
  ...
  \or %
    ...
    \ifcase#3%
    \or%
      \grehepisorlineaux{\gre@char@porrectus@one}{\gre@char@he@porrectus@one}{1}{#4}%
    \or%
      \grehepisorlineaux{\gre@char@porrectus@two}{\gre@char@he@porrectus@two}{1}{#4}%
    \or%
      \grehepisorlineaux{\gre@char@porrectus@three}{\gre@char@he@porrectus@three}{1}{#4}%
    \or%
      \grehepisorlineaux{\gre@char@porrectus@four}{\gre@char@he@porrectus@four}{1}{#4}%
    \or%
      \grehepisorlineaux{\gre@char@porrectus@five}{\gre@char@he@porrectus@five}{1}{#4}%
    \fi%
  \or%
    %case 12
  ...
  \or %
    %case 23
    \grehepisorlineaux{\gre@char@leading@debilis@one}{\gre@char@he@porrectus{#3}}{3}{#4}%
  \or%
    %case 24
  ...
  \or%
    %case 29
    \grehepisorlineaux{\gre@char@leading@debilis@one}{\gre@char@he@porrectusfl{#3}}{3}{#4}%
  \or%
    %case 30
  ...
  \or%
    %case 33
    \grehepisorlineaux{\gre@char@leading@debilis@two}{\gre@char@he@porrectusfl{#3}}{3}{#4}%
  \or%
    %case 34
