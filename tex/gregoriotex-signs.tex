...
\def\grehepisorline#1#2#3#4{%
  ...
  \ifcase#2 %
    %case 0
    \grehepisorlineaux{\char \gre@char@punctum}{40}{1}{#4}%
  \or%
    %case 1
    \grehepisorlineaux{\char \gre@char@smallpunctum}{42}{1}{#4}%
  \or%
    %case 2
    % a kind of flexus, it has the good width
    \grehepisorlineaux{\char \gre@char@flexusalt}{40}{1}{#4}%
  \or%
    %case 3
    % in order to go to the good place, we first make a kern of - the glyph before deminutus, which has the same width as a standard flexus deminutus
...
\def\grewritebar#1#2#3{%
  ...
  \or % 2 : minor
    \ifnum#2=1\relax %
      ...
      \grenobreak %
    \fi %
    \setbox\GreTempwidth=\hbox{\gregoriofont \char \gre@char@divisiominor{10}}%
    \raise\greglyphraisevalue\hbox{\gregoriofont \char \gre@char@divisiominor{10}}%
    #3\relax %
    \ifnum#2=1\relax %
      \grehskip\grespacearoundminor %
    \fi %
  \or % 3 : maior
    \ifnum#2=1\relax %
      ...
      \grenobreak %
    \fi %
    \setbox\GreTempwidth=\hbox{\gregoriofont \char \gre@char@divisiomaior{11}}%
  ...
  \or % 6 : dominican bar 1
    ...
    \ifnum#2=1\relax %
      ...
      \grenobreak %
    \fi %
    \setbox\GreTempwidth=\hbox{\gregoriofont \char \gre@char@divisiodominican{83}}%
    \raise\greglyphraisevalue\hbox{\gregoriofont \char \gre@char@divisiodominican{83}}%
    #3\relax %
    \ifnum#2=1\relax %
      \grehskip\grespacearoundminor %
    \fi %
  \or % 7 : dominican bar 2
    ...
    \ifnum#2=1\relax %
      ...
      \grenobreak %
    \fi %
    \setbox\GreTempwidth=\hbox{\gregoriofont \char \gre@char@divisiodominicanalt{84}}%
    \raise\greglyphraisevalue\hbox{\gregoriofont \char \gre@char@divisiodominicanalt{84}}%
    #3\relax %
    \ifnum#2=1\relax %
      \grehskip\grespacearoundminor %
    \fi %
