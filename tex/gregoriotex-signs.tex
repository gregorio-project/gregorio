...
% This macro should be used if the clef is alone in a syllable. In this case,
% we put it in a discretionary.
\def\grechangeclefdis#1#2#3#4{%
  % it makes no sense to change the clef when there is no clef...
  \grenormalclef %
  \grecalculateclefnum{#1}{#2}{#4}%
  \greclefchangespace = 16500 sp plus 1650 sp minus 16500 sp%
...
\gdef\grecurlybracechar{\gregoriofont\char 89}
\gdef\grebracechar{\gregoriofont\char 88}
...
\def\grevepisemusorrare#1#2#3#4#5{%
  ...
  \or%
    %case 18
    \grevepisemusorrareaux{0}{\char 74}{1}{-30\the\grefactor}{#3}{#4}{#5}%
  \or%
    %case 19
