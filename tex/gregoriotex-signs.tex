...
%% 54: the last note, if it's an oriscus with a bar (~0)
%% 55: the last note, if it's a virga aucta
...
\def\grevepisemusorrare#1#2#3#4#5{%
  ...
  \or%
    %case 49
    \grevepisemusorrareaux{0}{\gre@char@virga@line@bl}{0}{0}{#3}{#4}{#5}%
  \or%
    %case 50
  ...
  \or%
    %case 54
    \grevepisemusorrareaux{0}{\gre@char@oriscus@line@tr}{1}{0}{#3}{#4}{#5}%
  \or%
    %case 55
...
\def\grehepisorline#1#2#3#4{{%
  ...
  \or %
    %case 54
    \grehepisorlineaux{\gre@char@orisus@line@tr}{\gre@char@he@oriscus@line@tr}{2}{#4}%
  \or %
    %case 55
