...
\def\gre@alteration#1#2#3#4#5#6{%
  ...
  \ifnum\gre@alteration@type>6\relax % treat soft alterations like hard
...
\def\gre@alteration@isvisible#1#2{%
  \ifnum#2>6\relax % soft: depends on whether it's the first
    \gre@debugmsg{alteration}{\directlua{gregoriotex.is_first_alteration(#1)}}%
