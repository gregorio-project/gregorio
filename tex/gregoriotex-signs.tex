...
% macros for manipulating above flag
\def\grehidepclines{%
  \gre@hidepclinestrue%
}%
...
\def\GreHidePCLines{%
  \gre@warning{\protect\GreHidePCLines\space is deprecated.\MessageBreak Use \protect\grehidepclines\space instead.}%
  \gre@hidepclinestrue%
}%

\def\GreDontHidePCLines{%
  \gre@warning{\protect\GreDontHidePCLines\space is deprecated.\MessageBreak Use \protect\gredonthidepclines\space instead.}%
  \gre@hidepclinesfalse%
}%
...
\def\gredonthidealtaines{%
  \gre@hidealtlinesfalse%
}%

\def\GreHideAltLines{%
  \gre@warning{\protect\GreHideAltLines\space is deprecated.\MessageBreak Use \protect\grehidealtlines\space instead.}%
  \gre@hidealtlinestrue%
}%

\def\GreDontHideAltLines{%
  \gre@warning{\protect\GreDontHideAltLines\space is deprecated.\MessageBreak Use \protect\gredonthidealtlines\space instead.}%
  \gre@hidealtlinesfalse%
}%
