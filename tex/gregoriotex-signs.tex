...
\def\gre@draw@curlybrace#1{%
  ...
  \gre@metapost{
    ...
    fill
      (   (0,0)
      -- (0.01953,0)
      .. controls ((0.03239*p)+0.01953,0.01763) and ((0.08502*p)+0.01953,0.03065) .. ((0.15789*p)+0.01953,0.03906)
      .. controls ((0.23347*p)+0.01953,0.04801) and ((0.32659*p)+0.01953,0.05249) .. ((0.43725*p)+0.01953,0.05249)
      .. controls ((0.49663*p)+0.01953,0.05249) and ((0.59109*p)+0.01953,0.05086) .. ((0.72065*p)+0.01953,0.04761)
      .. controls ((0.82861*p)+0.01953,0.04408) and ((0.92173*p)+0.01953,0.04232) .. ((1*p)+0.01953,0.04232)
      .. controls ((1.13226*p)+0.01953,0.04232) and (p+0.09725,0.04842) .. (p+0.13306,0.06063)
      .. controls (p+0.16805,0.07365) and (p+0.1945,0.0906) .. (p+0.2124,0.11149)
      .. controls (p+0.23031,0.0906) and (p+0.25675,0.07365) .. (p+0.29175,0.06063)
      .. controls (p+0.32755,0.04842) and ((0.86774*p)+0.40527,0.04232) .. ((1*p)+0.40527,0.04232)
      .. controls ((1.07827*p)+0.40527,0.04232) and ((1.17139*p)+0.40527,0.04408) .. ((1.27935*p)+0.40527,0.04761)
      .. controls ((1.40891*p)+0.40527,0.05086) and ((1.50337*p)+0.40527,0.05249) .. ((1.56275*p)+0.40527,0.05249)
      .. controls ((1.67341*p)+0.40527,0.05249) and ((1.76653*p)+0.40527,0.04801) .. ((1.84211*p)+0.40527,0.03906)
      .. controls ((1.91498*p)+0.40527,0.03065) and ((1.96761*p)+0.40527,0.01763) .. ((2*p)+0.40527,0)
      -- ((2*p)+0.40527,0) -- ((2*q)+0.25879,0) -- ((2*q)+0.25879,0)
      .. controls ((1.97883*q)+0.25879,0.02658) and ((1.91534*q)+0.25879,0.04774) .. ((1.80952*q)+0.25879,0.06348)
      .. controls ((1.70582*q)+0.25879,0.07975) and ((1.57566*q)+0.25879,0.08789) .. ((1.41905*q)+0.25879,0.08789)
      .. controls ((1.36614*q)+0.25879,0.08789) and ((1.29841*q)+0.25879,0.08626) .. ((1.21587*q)+0.25879,0.08301)
      .. controls ((1.12063*q)+0.25879,0.07894) and ((1.04868*q)+0.25879,0.0769) .. ((1*q)+0.25879,0.0769)
      .. controls ((0.81218*q)+0.25879,0.0769) and (q+0.15038,0.10644) .. (q+0.14038,0.13102)
      -- (q+0.14038,0.13102) -- (q+0.11841,0.13102) -- (q+0.11841,0.13102)
      .. controls (q+0.10841,0.10644) and ((1.18782*q)+0,0.0769) .. ((1*q)+0,0.0769)
      .. controls ((0.95132*q)+0,0.0769) and ((0.87937*q)+0,0.07894) .. ((0.78413*q)+0,0.08301)
      .. controls ((0.70159*q)+0,0.08626) and ((0.63386*q)+0,0.08789) .. ((0.58095*q)+0,0.08789)
      .. controls ((0.42434*q)+0,0.08789) and ((0.29418*q)+0,0.07975) .. ((0.19048*q)+0,0.06348)
      .. controls ((0.08466*q)+0,0.04774) and ((0.02117*q)+0,0.02658) .. ((0*q)+0,0)
      -- cycle
      ) transformed t;
    setbounds currentpicture to
      ( (0,-0.67980) -- ((2*q)+0.25879,-0.67980) -- ((2*q)+0.25879,0.13102) -- (0,0.13102) -- cycle )
      transformed t;
    endfig;
  }%
}%
