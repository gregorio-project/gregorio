...
\def\grevepisemusorrare#1#2#3#4#5{%
  ...
  \or%
    %case 46
    \grevepisemusorrareaux{\gre@char@flexusalt@linebl}{\gre@char@punctum@line@blbr}{2}{0}{#3}{#4}{#5}%
  \or%
    %case 47
    \grevepisemusorrareaux{\gre@char@flexusaltone@linebl}{\gre@char@punctum@line@bl}{2}{0}{#3}{#4}{#5}%
  \fi%
  \relax%
}%
...
\def\grehepisorline#1#2#3#4{{%
  ...
  \or%
    %case 46
    \grehepisorlineaux{\gre@char@flexusalt@linebl}{\gre@char@he@punctum@line@blbr}{2}{#4}%
  \or%
    %case 47
    \grehepisorlineaux{\gre@char@flexusaltone@linebl}{\gre@char@he@punctum@line@bl}{2}{#4}%
  \fi%
  \relax%
}}%
