...
\gdef\grecurlybracechar{\gregoriochar\gre@char@curlybrace}%
\gdef\grebracechar{\gregoriochar\gre@char@brace}%
...
\def\greovercurlybrace#1#2#3#4#5{%
  ...
  \hbox to 0pt{%
    ...
    \ifnum#2=1\relax %
      ...
      \raise\gre@dimen@glyphraisevalue\hbox{%
        \gregoriochar\gre@char@accentus\relax %
      }%
      \hss %
    \fi %
  }%
...
\def\grepunctummora#1#2#3#4{%
  ...
  \or %
    ...
    \setbox\GreTempwidth=\hbox{\gregoriochar\gre@char@flexus}%
    \gre@dimen@temp@five=\wd\GreTempwidth %
    \setbox\GreTempwidth=\hbox{\gregoriochar\gre@char@punctum}%
...
\def\grevepisemusorrareaux#1#2#3#4#5#6#7{%
  ...
  \or % rare sign
    \setbox\GreTempsign=\hbox{\gregoriochar#5}%
  \or % choral sign
...
\def\grehepisorlineaux#1#2#3#4{%
  ...
  \setbox\GreTempsign=\hbox{\gregoriochar{#2}}%
  % we set tempwidth to half a punctum malus half the sign width, so that the centers are aligned
  \gre@dimen@temp@two=\wd\GreTempsign %
...
\def\grehepisemusbridge#1#2#3{%
  \ifnum\greaddhepisemusbridges=1\relax %
    \gre@calculate@glyphraisevalue{#1}{9}%
    \raise\gre@dimen@glyphraisevalue\hbox to 0pt{\gregoriochar\gre@char@he@punctum\hss}%
  \fi %
  \relax %
}%
...
\def\grewritebar#1#2#3{%
  ...
  \ifcase#1 % 0 : virgula
    \ifnum#2=1\relax %
      ...
      \grenobreak %
    \fi %
    \setbox\GreTempwidth=\hbox{\gregoriochar\gre@char@virgula}%
    \raise\gre@dimen@glyphraisevalue\hbox{\gregoriochar\gre@char@virgula}%
    #3\relax %
    \ifnum#2=1\relax %
      \gre@skip@temp@four = \gre@skip@spacearoundsmallbar%
      \grehskip\gre@skip@temp@four %
  ...
  \or % 1 : minima
    \ifnum#2=1\relax %
      ...
      \grenobreak %
    \fi %
    \setbox\GreTempwidth=\hbox{\gregoriochar\gre@char@divisiominima}%
    \raise\gre@dimen@glyphraisevalue\hbox{\gregoriochar\gre@char@divisiominima}%
    #3\relax %
    \ifnum#2=1\relax %
      \gre@skip@temp@four = \gre@skip@spacearoundsmallbar%
      \grehskip\gre@skip@temp@four %
  ...
  \or % 2 : minor
    \ifnum#2=1\relax %
      ...
      \grenobreak %
    \fi %
    \setbox\GreTempwidth=\hbox{\gregoriochar\gre@char@divisiominor}%
    \raise\gre@dimen@glyphraisevalue\hbox{\gregoriochar\gre@char@divisiominor}%
    #3\relax %
    \ifnum#2=1\relax %
      \gre@skip@temp@four = \gre@skip@spacearoundminor%
      \grehskip\gre@skip@temp@four %
  ...
  \or % 3 : maior
    \ifnum#2=1\relax %
      ...
      \grenobreak %
    \fi %
    \setbox\GreTempwidth=\hbox{\gregoriochar\gre@char@divisiomaior}%
  ...
  \or % 6 : dominican bar 1
    ...
    \ifnum#2=1\relax %
      ...
      \grenobreak %
    \fi %
    \setbox\GreTempwidth=\hbox{\gregoriochar\gre@char@divisiodominican}%
    \raise\gre@dimen@glyphraisevalue\hbox{\gregoriochar\gre@char@divisiodominican}%
    #3\relax %
    \ifnum#2=1\relax %
      \gre@skip@temp@four = \gre@skip@spacearoundminor%
      \grehskip\gre@skip@temp@four %
  ...
  \or % 7 : dominican bar 2
    ...
    \ifnum#2=1\relax %
      ...
      \grenobreak %
    \fi %
    \setbox\GreTempwidth=\hbox{\gregoriochar\gre@char@divisiodominicanalt}%
    \raise\gre@dimen@glyphraisevalue\hbox{\gregoriochar\gre@char@divisiodominicanalt}%
    #3\relax %
    \ifnum#2=1\relax %
      \gre@skip@temp@four = \gre@skip@spacearoundminor%
      \grehskip\gre@skip@temp@four %
...
\def\gredivisiomaiorsymbol{%
  \ifnum\gre@stafflinefactor=17\relax %
    %\gre@calculate@glyphraisevalue{g}{0}% bar glyphs are made to be at this height
    \raise\gre@dimen@glyphraisevalue\hbox{\gregoriochar\gre@char@divisiomaior}%
  \else %
    \setbox\GreTempwidth=\hbox{\gregoriochar\gre@char@divisiomaior}%
...
\gdef\grepunctumcavumchar{\gregoriochar\gre@char@punctumcavumalt}%
\gdef\grelineapunctumcavumchar{\gregoriochar\gre@char@lineapunctumcavumalt}%
\gdef\grepunctumcavumholechar{\gregoriochar\gre@char@punctumcavumholealt}%
\gdef\grelineapunctumcavumholechar{\gregoriochar\gre@char@lineapunctumcavumholealt}%
\relax %
}%

\def\UseNormalPunctumCavum{%
\gdef\grepunctumcavumchar{\gregoriochar\gre@char@punctumcavum}%
\gdef\grelineapunctumcavumchar{\gregoriochar\gre@char@lineapunctumcavum}%
\gdef\grepunctumcavumholechar{\gregoriochar\gre@char@punctumcavumhole}%
\gdef\grelineapunctumcavumholechar{\gregoriochar\gre@char@lineapunctumcavumhole}%
\relax %
}%
