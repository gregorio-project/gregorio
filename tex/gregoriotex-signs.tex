...
%% 28: the two first notes, if it is a porrectus with second ambitus of 1
%% 29: the two first notes, if it is a torculus resupinus with third ambitus of 1
...
\def\grehepisorline#1#2#3#4{%
  ...
  \ifcase#2 %
    %case 0
    \grehepisorlineaux{\gre@char@punctum}{\gre@char@he@punctum}{1}{#4}%
  \or%
    %case 1
    \grehepisorlineaux{\gre@char@smallpunctum}{\gre@char@he@initio}{1}{#4}%
  \or%
    %case 2
    % a kind of flexus, it has the good width
    \grehepisorlineaux{\gre@char@flexusalt}{\gre@char@he@punctum}{1}{#4}%
  \or%
    %case 3
    % in order to go to the good place, we first make a kern of - the glyph before deminutus, which has the same width as a standard flexus deminutus
    \grehepisorlineaux{\gre@char@flexusdeminutus}{\gre@char@he@punctum}{1}{#4}%
  \or%
    %case 4
    % a torculus, it has the good width
    \grehepisorlineaux{\gre@char@torculus}{\gre@char@he@punctum}{1}{#4}%
  \or%
    %case 5
    % torculus deminutus has the good width
    \grehepisorlineaux{\gre@char@torculusdeminutus}{\gre@char@he@punctum}{1}{#4}%
  \or%
    %case 6
  ...
  \or%
    %case 12
    \grehepisorlineaux{\gre@char@punctuminclinatum}{\gre@char@he@inclinatum}{1}{#4}%
  \or%
    %case 13
    \grehepisorlineaux{\gre@char@punctuminclinatumdem}{\gre@char@he@inclinatumdem}{1}{#4}%
  \or%
    %case 14
    \grehepisorlineaux{\gre@char@stropha}{\gre@char@he@stropha}{1}{#4}%
  \or%
    %case 15
    \grehepisorlineaux{\gre@char@quilisma}{\gre@char@he@quilisma}{1}{#4}%
  \or%
    %case 16
    \grehepisorlineaux{\gre@char@oriscus}{\gre@char@he@oriscus}{1}{#4}%
  \or%
    %case 17
    \grehepisorlineaux{\gre@char@flexusaltone}{\gre@char@he@punctum}{1}{#4}%
  \or %
    %case 18
    \grehepisorlineaux{\gre@char@peshigh}{\gre@char@he@smallpunctum}{1}{#4}%
  \or %
    %case 19
  ...
  \or %
    ...
    \ifcase#3%
    \or%
      \grehepisorlineaux{\gre@char@porrectus@one}{\gre@char@he@punctum}{1}{#4}%
    \or%
      \grehepisorlineaux{\gre@char@porrectus@two}{\gre@char@he@punctum}{1}{#4}%
    \or%
      \grehepisorlineaux{\gre@char@porrectus@three}{\gre@char@he@punctum}{1}{#4}%
    \or%
      \grehepisorlineaux{\gre@char@porrectus@four}{\gre@char@he@punctum}{1}{#4}%
    \or%
      \grehepisorlineaux{\gre@char@porrectus@five}{\gre@char@he@punctum}{1}{#4}%
    \fi%
  \or %
    %case 22
    \ifcase#3%
  ...
  \or%
    %case 24
    \grehepisorlineaux{\gre@char@pesinitauctusone}{\gre@char@he@punctum}{1}{#4}%the episemus is not quite long enough so I assumed a different width for now...
  \or%
    % 25-27 make no sense for horizontal episemus
  \or\or\or%
    %case 28
    \ifcase#3%
    \or%
      \grehepisorlineaux{0}{\gre@char@he@porrectus@amone@one}{0}{#4}%
    \or%
      \grehepisorlineaux{0}{\gre@char@he@porrectus@amone@two}{0}{#4}%
    \or%
      \grehepisorlineaux{0}{\gre@char@he@porrectus@amone@three}{0}{#4}%
    \or%
      \grehepisorlineaux{0}{\gre@char@he@porrectus@amone@four}{0}{#4}%
    \or%
      \grehepisorlineaux{0}{\gre@char@he@porrectus@amone@five}{0}{#4}%
    \fi%
  \or%
    %case 29
    \ifcase#3%
    \or%
      \grehepisorlineaux{\gre@char@porrectus@amone@one}{\gre@char@he@porrectus@amone@one}{1}{#4}%
    \or%
      \grehepisorlineaux{\gre@char@porrectus@amone@two}{\gre@char@he@porrectus@amone@two}{1}{#4}%
    \or%
      \grehepisorlineaux{\gre@char@porrectus@amone@three}{\gre@char@he@porrectus@amone@three}{1}{#4}%
    \or%
      \grehepisorlineaux{\gre@char@porrectus@amone@four}{\gre@char@he@porrectus@amone@four}{1}{#4}%
    \or%
      \grehepisorlineaux{\gre@char@porrectus@amone@five}{\gre@char@he@porrectus@amone@five}{1}{#4}%
    \fi%
  \fi%
  \relax%
}%
