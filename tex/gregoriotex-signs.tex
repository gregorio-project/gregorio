...
\def\grehepisorline#1#2#3#4{%
  ...
  \or %
    ...
    \ifcase#3%
    \or%
      \grehepisorlineaux{\gre@char@porrectus@one}{\gre@char@he@porrectusfl@one}{2}{#4}%
    \or%
      \grehepisorlineaux{\gre@char@porrectus@two}{\gre@char@he@porrectusfl@two}{2}{#4}%
    \or%
      \grehepisorlineaux{\gre@char@porrectus@three}{\gre@char@he@porrectusfl@three}{2}{#4}%
    \or%
      \grehepisorlineaux{\gre@char@porrectus@four}{\gre@char@he@porrectusfl@four}{2}{#4}%
    \or%
      \grehepisorlineaux{\gre@char@porrectus@five}{\gre@char@he@porrectusfl@five}{2}{#4}%
    \fi%
  \or%
    %case 12
  ...
  \or %
    ...
    \ifcase#3%
    \or%
      \grehepisorlineaux{\gre@char@porrectus@one}{\gre@char@he@punctum}{2}{#4}%
    \or%
      \grehepisorlineaux{\gre@char@porrectus@two}{\gre@char@he@punctum}{2}{#4}%
    \or%
      \grehepisorlineaux{\gre@char@porrectus@three}{\gre@char@he@punctum}{2}{#4}%
    \or%
      \grehepisorlineaux{\gre@char@porrectus@four}{\gre@char@he@punctum}{2}{#4}%
    \or%
      \grehepisorlineaux{\gre@char@porrectus@five}{\gre@char@he@punctum}{2}{#4}%
    \fi%
  \or %
    %case 22
    \ifcase#3%
