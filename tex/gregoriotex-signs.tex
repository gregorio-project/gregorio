...
\def\vepisemusorrare#1#2#3{%
  ...
  \or%
    ...
    \vepisemusorrareaux{\char 15371}{\char 17}{2}{0}{#3}%
  \or%
    %case 5
    % is a torculus deminutus, it has the good width
    \vepisemusorrareaux{\char 15884}{\char 17}{2}{0}{#3}%
  \or%
    %case 6
  ...
  \or%
    ...
    \vepisemusorrareaux{\char 5634}{\char 17}{3}{0}{#3}%
  \or%
    %case 22 %
    % 5633 is a flexus without bar with ambitus of 1
    \vepisemusorrareaux{\char 5633}{\char 17}{3}{0}{#3}%
  \or%
    %case 23
    \vepisemusorrareaux{\char 1986}{\char 17}{3}{0}{#3}%
  \or%
    %case 24
...
\xdef\punctumcavumchar{\char 34}%
\xdef\lineapunctumcavumchar{\char 36}%
\xdef\punctumcavumholechar{\char 77}%
\xdef\lineapunctumcavumholechar{\char 79}%
\relax %
}
...
\def\GreDontHideLines{%
\xdef\grehidelines{0}%
}

\GreDontHideLines

\def\punctumcavum#1#2#3{%
  \calculateglyphraisevalue{#1}{0}%
  \ifnum\grehidelines=1\relax %
    \fillhole{\punctumcavumholechar}%
  \fi %
  \glyph{\punctumcavumchar}{#1}{#2}{#3}%
  \relax %
}

% Same as the one before, but for naturals.
\def\lineapunctumcavum#1#2#3{%
  \calculateglyphraisevalue{#1}{0}%
  \ifnum\grehidelines=1\relax %
    \fillhole{\lineapunctumcavumholechar}%
  \fi %
  \glyph{\lineapunctumcavumchar}{#1}{#2}{#3}%
  \relax %
}
