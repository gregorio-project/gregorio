...
\def\grevarbracer#1#2#3{%
  ...
  \else %
    \pdfsavepos %
  \fi %
  \grewriteaux{\directlua{gregoriotex.get_cur_score_id()}.#1.#3=\number\pdflastxpos}%
  \relax %
}

\def\grevarbraces#1#2{\directlua{gregoriotex.var_brace_len(#1)}\grevarbracer{#1}{#2}{start}}
\def\grevarbracee#1#2{\grevarbracer{#1}{#2}{end}}
