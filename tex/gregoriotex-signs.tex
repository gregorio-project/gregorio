...
\def\grediscretionary#1#2{%
  ...
  \discretionary{%
    ...
    #1%
    \gre@temp@skip@four = \grekernbeforeeol\relax%
    \kern\gre@temp@skip@four %
    }{%
...
\def\gresetlinesclef#1#2#3#4{%
  \grelocalleftbox{%
    \gre@temp@skip@four = \gre@additionalleftspace%
    \kern\gre@temp@skip@four %
    \copy\GreLines% draws the lines
    \unkern %
    \ifnum\greremoveclefcount=0\relax %
      \gre@temp@skip@four = \gre@afterclefnospace%
      \hbox{\gretypekey{#1}{#2}{0}{#3}{#4}\hskip\gre@temp@skip@four}%
    \else %
      \gre@temp@skip@four = \gre@noclefspace%
      \hbox{\kern\gre@temp@skip@four}%
    \fi %
  }%
  \xdef\greclefflat{#4}%
  \relax%
...
\def\greupdatelinesclef{%
  \ifnum\greclefnum > 5\relax%
    \gre@temp@count@three=\greclefnum %
    \advance\gre@temp@count@three by -4\relax %
    \gresetlinesclef{f}{\gre@temp@count@three}{1}{\greclefflat}%
  \else %
...
\def\gretypekey#1#2#3#4#5{%
  ...
  \fi%
  \gre@temp@skip@two=\gre@spaceafterlineclef %
  \ifnum#4=0\relax %
    \gre@temp@skip@two=\gre@afterclefnospace %
  \fi %
  \ifx c#1% we check if it is a c key
    \ifcase#3%
      \raise\gre@glyphraisevalue\hbox{\grecclefchar}%\hskip\gre@temp@skip@two}
      \setbox\GreTempwidth=\hbox{\grecclefchar}%
      \global\gre@clefwidth=\wd\GreTempwidth %
    \or%
      \raise\gre@glyphraisevalue\hbox{\greincclefchar}%\hskip\gre@temp@skip@two}
    \fi%
  \else % we consider that it is a f key
    \ifcase#3%
      \raise\gre@glyphraisevalue\hbox{\grefclefchar}%\hskip\gre@temp@skip@two}
      \setbox\GreTempwidth=\hbox{\grefclefchar}%
      \global\gre@clefwidth=\wd\GreTempwidth %
    \or%
      \raise\gre@glyphraisevalue\hbox{\greinfclefchar}%\hskip\gre@temp@skip@two}
    \fi%
  \fi%
  \if a#5%
    \grehskip\gre@temp@skip@two %
  \else %
    \gre@temp@skip@four = \gre@clefflatspace%
    \grehskip\gre@temp@skip@four %
    \greflat{#5}{1}%
    \grehskip\gre@temp@skip@two %
  \fi %
  \relax %
...
\def\grechangeclef#1#2#3#4{%
  ...
  \fi %
  \ifnum#3=1\relax %
    \gre@temp@skip@four = \gre@clefchangespace%
    \grehskip\gre@temp@skip@four %
  \else %
    ...
    \gre@temp@skip@four = -\gre@spacearoundclefbars%
    \grehskip\gre@temp@skip@four %
  \fi %
...
\def\gresetcusto#1{%
  \ifnum\greinsidediscretionary=0\relax %
    \ifnum\greblockcusto=0\relax %
      ...
      \gre@temp@skip@four = \gre@spacebeforecusto%
      \hskip\gre@temp@skip@four %
...
\def\gremanualcusto#1{%
  \gre@temp@skip@four = \gre@spacebeforecusto%
  \kern\gre@temp@skip@four\grecusto{#1}%
}%

% macro that typesets an additional line at the top for custos at end of line

\def\greadditionaltopcustolineend{%
  \gre@temp@dimen@five=\gre@staffheight %
  \advance\gre@temp@dimen@five by \gre@spacebeneathtext %
  \advance\gre@temp@dimen@five by \gre@spacelinestext %
  \advance\gre@temp@dimen@five by \gre@interstafflinespace %
  \advance\gre@temp@dimen@five by \gre@additionalbottomspace %
  \advance\gre@temp@dimen@five by \gre@currenttranslationheight %
  \raise\gre@temp@dimen@five %
  \hbox to 0pt{%
    \greadditionalstafflinesformat %
    \kern\gre@temp@dimen@three %
    \gre@temp@dimen@five=\wd\GreTempsign %
    \advance\gre@temp@dimen@five by \gre@additionalcustoslineswidth %
    \kern-\gre@temp@dimen@five %
    \vrule width \gre@temp@dimen@five height \gre@stafflineheight%
    \hss %
  }%
  \relax %
}%
...
\def\greadditionalbottomcustolineend{%
  \gre@temp@dimen@five=\gre@spacebeneathtext %
  \advance\gre@temp@dimen@five by \gre@spacelinestext %
  \advance\gre@temp@dimen@five by \gre@additionalbottomspace %
  \advance\gre@temp@dimen@five by \gre@currenttranslationheight %
  \advance\gre@temp@dimen@five by -\gre@interstafflinespace %
  \advance\gre@temp@dimen@five by -\gre@stafflineheight %
  \raise\gre@temp@dimen@five %
  \hbox to 0pt{%
    \greadditionalstafflinesformat %
    \kern\gre@temp@dimen@three %
...
\def\greadditionaltopcustolinemiddle{%
  ...
  \hbox to 0pt{%
    ...
    \hss %
    \kern\gre@temp@dimen@three %
    \gre@temp@dimen@five=\gre@additionalcustoslineswidth %
    \multiply\gre@temp@dimen@five by 2%
    \advance\gre@temp@dimen@five by \wd\GreTempsign %
    \vrule width \gre@temp@dimen@five height \gre@stafflineheight%
    \hss %
  }%
  \relax %
...
\def\grepunctummora#1#2#3#4{%
  \grenobreak %
  \ifcase#2\relax %
    \gre@temp@skip@four = \gre@spacebeforesigns%
    \hskip\gre@temp@skip@four%
  \or %
    \gre@temp@skip@four = \gre@spacebeforesigns%
    \kern\gre@temp@skip@four %
  ...
  \ifnum#4=1\relax %
    \ifnum\greisonaline=1\relax %
      \gre@temp@dimen@three=3700sp%
      \multiply\gre@temp@dimen@three by \the\grefactor %
      \kern-\gre@temp@dimen@three %
      \gre@temp@dimen@three =4500sp%
      \multiply\gre@temp@dimen@three by \the\grefactor %
      \advance\gre@glyphraisevalue by -\gre@temp@dimen@three %
    \else %
      \gre@temp@dimen@three =2500sp%
      \multiply\gre@temp@dimen@three by \the\grefactor %
      \advance\gre@glyphraisevalue by -\gre@temp@dimen@three %
    \fi %
  \fi %
  \grenobreak %
  \raise \gre@glyphraisevalue \hbox{\grepunctummorachar}%
  \grenobreak %
  \ifcase#2\relax\or %
    \setbox\GreTempwidth=\hbox{\grepunctummorachar}%
    \gre@temp@skip@four = -\wd\GreTempwidth %
    \kern\gre@temp@skip@four%
    \gre@temp@skip@four = -\gre@spacebeforesigns%
    \kern\gre@temp@skip@four %
  \or %
...
\def\grelowchoralsign#1#2#3{%
  \grenobreak %
  \gre@temp@skip@four = \gre@beforechoralsignspace%
  \hskip\gre@temp@skip@four %
  \grenobreak %
  \ifnum#3=1\relax %
  ...
  \fi %
  \raise\gre@glyphraisevalue\hbox{\grelowchoralsignstyle{#2}}%
  \relax %
}%
...
\def\grevepisemusorrareaux#1#2#3#4#5#6#7{%
  % first we set \gre@temp@dimen@three to the width of the last glyph
  \gre@temp@dimen@three=\gre@lastglyphwidth %
  \setbox\GreTempsign=\hbox{\gregoriofont #2}%
  \gre@temp@dimen@two=\wd\GreTempsign %
  \divide\gre@temp@dimen@two by 2\relax %
  \ifcase#3%
  % tempwidth is the width of the last glyph
    \advance\gre@temp@dimen@three by -\gre@temp@dimen@two %
  \or%
    \gre@temp@dimen@three=\gre@temp@dimen@two %
  \or%
    \setbox\GreTempsign=\hbox{\gregoriofont #1}%
    \gre@temp@dimen@three=\wd\GreTempsign %
    \advance\gre@temp@dimen@three by -\gre@temp@dimen@two %
  \or %
    \setbox\GreTempsign=\hbox{\gregoriofont #1}%
    \advance\gre@temp@dimen@three by -\wd\GreTempsign %
    \advance\gre@temp@dimen@three by \gre@temp@dimen@two %
  \fi%
  \kern-\gre@temp@dimen@three % we do it here because of the ictus
  ...
  % then we draw the sign
    ...
    \gre@temp@dimen@two=\wd\GreTempsign %
    \divide\gre@temp@dimen@two by 2 %
    \advance\gre@temp@dimen@three by \gre@temp@dimen@two %
    \kern-\gre@temp@dimen@two%
    \gre@temp@skip@four = #4sp%
    \kern \gre@temp@skip@four%
    \raise \gre@glyphraisevalue \copy\GreTempsign %
    \kern -\gre@temp@skip@four%
    % and finally we go back to the end of the glyph, where we were first
    \advance\gre@temp@dimen@three by -2\gre@temp@dimen@two %
  \fi %
  \kern\gre@temp@dimen@three%
  \relax%
}%
...
\def\grehepisorlineaux#1#2#3#4{%
  ...
  \else %
    \gre@temp@dimen@five=\gre@additionallineswidth %
    \kern-\gre@temp@dimen@five %
    \advance\gre@temp@dimen@two by 2\gre@temp@dimen@five %
  \fi %
  \ifcase#4%
    %case of hepisemus
    \raise \gre@glyphraisevalue \copy\GreTempsign %
  ...
  \or % case of a line at the top
    ...
    \raise\gre@glyphraisevalue\hbox{\vrule height \gre@stafflineheight width \gre@temp@dimen@two}%
    \kern\gre@temp@dimen@five %
...
\def\greadditionalline#1#2#3{%
  \ifnum\greremovelinescount=0\relax %
    \xdef\gresavedglyphraise{\the\gre@glyphraisevalue}%
    {\greadditionalstafflinesformat %
    \grehepisorline{a}{#1}{#2}{#3}%
    }%
    \gre@glyphraisevalue=\gresavedglyphraise %
  \fi %
  \relax %
}%
...
\def\grewritebar#1#2#3{%
  ...
  \ifcase#1 % 0 : virgula
    \ifnum#2=1\relax %
      \gre@temp@skip@four = \gre@spacearoundsmallbar%
      \grehskip\gre@temp@skip@four %
      \grenobreak %
    \fi %
  ...
  \or % 2 : minor
    \ifnum#2=1\relax %
      \gre@temp@skip@four = \gre@spacearoundminor%
      \grehskip\gre@temp@skip@four %
      \grenobreak %
    \fi %
  ...
  \or % 3 : maior
    \ifnum#2=1\relax %
      \gre@temp@skip@four = \gre@spacearoundmaior%
      \grehskip\gre@temp@skip@four %
      \grenobreak %
    \fi %
  ...
  \or % 4 : finalis
    \ifnum#2=1\relax %
      \gre@temp@skip@four = \gre@spacearoundfinalis%
      \grehskip\gre@temp@skip@four %
      \grenobreak %
    \fi %
  ...
  \or % 5 : finalis
    \ifnum#2=1\relax %
      \gre@temp@skip@four = \gre@spacebeforefinalfinalis%
      \grehskip\gre@temp@skip@four %
      \grenobreak %
    \fi %
    \setbox\GreTempwidth=\hbox{\gredivisiofinalissymbol}%
...
\def\gredivisiomaiorsymbol{%
  ...
  \else %
    ...
    \gre@temp@dimen@five=\gre@additionalbottomspace %
    \advance\gre@temp@dimen@five by \gre@spacebeneathtext %
    \advance\gre@temp@dimen@five by \gre@spacelinestext %
    \advance\gre@temp@dimen@five by \gre@currenttranslationheight %
    % we calculate the height of the bar
    \raise\gre@temp@dimen@five\hbox{\vrule height \gre@staffheight width \wd\GreTempwidth}%
  \fi %
  \relax %
}%
...
\def\gredivisiofinalissymbol{%
  \gre@calculate@glyphraisevalue{g}{0}% bar glyphs are made to be at this height
  \gredivisiomaiorsymbol %
  \gre@temp@dimen@four = 12000 sp%
  \multiply\gre@temp@dimen@four by \the\grefactor%
  \kern\gre@temp@dimen@four%
  \grenobreak %
  \gredivisiomaiorsymbol %
}%
...
\def\grealteration#1#2#3#4{%
  ...
  \ifnum#4=0\relax %
    ...
    \grenobreak %
    \ifnum\the\grefirstglyph=1\relax %
      \global\advance\gre@notesaligncenter by \wd\GreTempwidth %
      \global\advance\gre@notesaligncenter by \gre@alterationspace %
      \gre@temp@skip@four = \gre@alterationspace%
      \kern\gre@temp@skip@four %
    \else %
      \gre@temp@skip@four = \gre@alterationspace%
      \grehskip\gre@temp@skip@four %
...
\def\grepunctumcavum#1#2#3#4#5{%
  ...
  \global\gre@lastglyphwidth=\wd\GreTempwidth %
  \gre@temp@skip@four = \gre@lastglyphwidth%
  \kern\gre@temp@skip@four %
  #4\relax %
  \kern-\gre@temp@skip@four %
  \gre@calculate@glyphraisevalue{#1}{0}%
