...
\def\grevarbracer#1#2#3{%
  ...
  \else %
    \pdfsavepos
  \fi %
  \grewriteaux{#3.\directlua{gregoriotex.get_cur_score_id()}.#1:\number\pdflastxpos}%
  \relax %
}

\def\grevarbraces#1#2{0mm\grevarbracer{#1}{#2}{varbracestart}}
\def\grevarbracee#1#2{\grevarbracer{#1}{#2}{varbraceend}}
