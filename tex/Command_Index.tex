...
\verb=\grezerhyph=%tex.tex
	Macho to typeset a zero-width hyphen (the hyphen is visible, it is treated as if it had 0 width though.  Used for fine tuning spacing (especially at line endings).
