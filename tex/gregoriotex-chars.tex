...
\def\gre@char@flexusaltone@linebl{\grecpFlexusAmOneLineBL}%
\def\gre@char@flexusalt@linebl{\grecpFlexusLineBL}%
...
\def\gre@char@he@porrectus#1{%
  \ifcase#1\grecpHEpisemusPunctum%
...
\def\gre@char@he@porrectus@amone#1{%
  \ifcase#1\grecpHEpisemusPunctum%
...
\def\gre@char@he@porrectusfl#1{%
  \ifcase#1\grecpHEpisemusPunctum%
  \or\grecpHEpisemusPorrectusFlexusOne%
