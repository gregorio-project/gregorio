...
\def\gre@char@he@punctum@line@tl{\grecpHEpisemusPunctumLineTL}%
\def\gre@char@he@punctum@line@bl{\grecpHEpisemusPunctumLineBL}%
\def\gre@char@he@punctum@line@blbr{\grecpHEpisemusPunctumLineBLBR}%
...
\def\gre@char@he@porrectus#1{%
  \ifcase#1\grecpPunctum%
  \or\grecpHEpisemusPorrectusOne%
  \or\grecpHEpisemusPorrectusTwo%
  \or\grecpHEpisemusPorrectusThree%
  \or\grecpHEpisemusPorrectusFour%
  \or\grecpHEpisemusPorrectusFive
  \fi%
}%
\def\gre@char@he@porrectus@amone@one#1{%
  \ifcase#1\grecpPunctum%
  \or\grecpHEpisemusPorrectusAmOneOne%
  \or\grecpHEpisemusPorrectusAmOneTwo%
  \or\grecpHEpisemusPorrectusAmOneThree%
  \or\grecpHEpisemusPorrectusAmOneFour%
  \or\grecpHEpisemusPorrectusAmOneFive%
  \fi%
}%
\def\gre@char@he@porrectusfl@one#1{%
  \ifcase#1\grecpHEpisemusPorrectusFlexusOne%
...
\def\gre@char@he@quilisma@line@tr{\grecpHEpisemusQuilismaLineTR}%
\def\gre@char@he@oriscus{\grecpHEpisemusOriscus}%
\def\gre@char@he@oriscus@line@tr{\grecpHEpisemusOriscusLineTR}%
