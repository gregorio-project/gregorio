...
\def\gre@fontchar@flat{\gre@font@neumebase\GreCPFlat}%
\def\gre@fontchar@flathole{\gre@font@neumebase\GreCPFlatHole}%
\def\gre@fontchar@natural{\gre@font@neumebase\GreCPNatural}%
\def\gre@fontchar@naturalhole{\gre@font@neumebase\GreCPNaturalHole}%
\def\gre@fontchar@sharp{\gre@font@neumebase\GreCPSharp}%
\def\gre@fontchar@sharphole{\gre@font@neumebase\GreCPSharpHole}%
\def\gre@fontchar@cclef{\gre@font@neumebase\GreCPCClef}%
\def\gre@fontchar@fclef{\gre@font@neumebase\GreCPFClef}%
\def\gre@fontchar@incclef{\gre@font@neumebase\GreCPCClefChange}%
\def\gre@fontchar@infclef{\gre@font@neumebase\GreCPFClefChange}%
\def\gre@fontchar@punctummora{\gre@font@neumebase\GreCPAuctumMora}%
\def\gre@fontchar@verticalepisemus{\gre@font@neumebase\GreCPVEpisemus}%
\def\gre@fontchar@custostoplong{\gre@font@neumebase\GreCPCustosUpLong}%
\def\gre@fontchar@custostopshort{\gre@font@neumebase\GreCPCustosUpShort}%
\def\gre@fontchar@custostopmiddle{\gre@font@neumebase\GreCPCustosUpMedium}%
\def\gre@fontchar@custosbottomlong{\gre@font@neumebase\GreCPCustosDownLong}%
\def\gre@fontchar@custosbottomshort{\gre@font@neumebase\GreCPCustosDownShort}%
\def\gre@fontchar@custosbottommiddle{\gre@font@neumebase\GreCPCustosDownMedium}%
\def\gre@fontchar@abovebarbrace{\gre@font@neumebase\GreCPBarBrace}%
\def\gre@fontchar@punctum{\gre@font@neumebase\GreCPPunctum}%
