\xdef\gre@char@divisiomaior{11}
\xdef\gre@char@virgula{8}
\xdef\gre@char@divisiominima{9}
\xdef\gre@char@divisiominor{10}
\xdef\gre@char@divisiodominican{83}
\xdef\gre@char@divisiodominicanalt{84}

\xdef\gre@char@punctumcavum{34}
\xdef\gre@char@lineapunctumcavum{36}
\xdef\gre@char@punctumcavumhole{77}
\xdef\gre@char@lineapunctumcavumhole{79}
\xdef\gre@char@punctumcavumalt{75}
\xdef\gre@char@lineapunctumcavumalt{76}
\xdef\gre@char@punctumcavumholealt{78}
\xdef\gre@char@lineapunctumcavumholealt{80}

\xdef\gre@char@curlybrace{89}
\xdef\gre@char@brace{88}

\xdef\gre@char@smallpunctum{13}
\xdef\gre@char@punctum{17}
\xdef\gre@char@punctuminclinatum{19}
\xdef\gre@char@stropha{20}
\xdef\gre@char@strophaaucta{21}
\xdef\gre@char@quilisma{26}
\xdef\gre@char@oriscus{27}
\xdef\gre@char@oriscusauctus{28}
\xdef\gre@char@lineapunctum{35}
\xdef\gre@char@peshigh{74}
\xdef\gre@char@punctuminclinatumdem{32}
\xdef\gre@char@pesinitauctus{1986}
\xdef\gre@char@flexus{2051}
\xdef\gre@char@flexusaltone{5633}
\xdef\gre@char@flexusalt{5634}
\xdef\gre@char@flexusdeminutus{5250}
\xdef\gre@char@torculus{15371}
\xdef\gre@char@torculusdeminutus{15884}
...
\gdef\greabovebarbracechar{\gregoriofont\char 90}%
\gdef\grepunctumchar{\gregoriofont\char 17}%
\relax %
}
