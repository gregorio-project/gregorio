...
\def\gresep#1#2{%
  ...
  {\font\grelinefont=gresym at #2pt\grelinefont \char \gretempfactor}%
  \relax%
}
...
\def\gresixstar{%
  {\gregoriosymbolfont \char 71}%
  \relax %
}

%you can redefine this with the width you want
\font\gregoriosymbolfont=gresym at 12pt
