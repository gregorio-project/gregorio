...
\def\forcedgtexinclude{%
	\@gtexforceincludetrue%
}
...
%
% If \if@gtexforceinclude is true, then we simply try to include the file as it is given to us.  This is the old behavior.
%
% If \if@gabcforcecompile is true, pass true to the lua function.
...
\ifdefined\includetexscore%
	\gre@warning{\protect\includetexscore\space is deprecated. \MessageBreak Use \protect\includescore\space instead.\MessageBreak Perhaps with the f option.}%
\else%
...
\def\greincludetexscore#1{%
	\gre@warning{\protect\greincludetexscore\space is deprecated.\MessageBreak Use \protect\includescore\space instead.\MessageBreak Perhaps with the f option.}%
	\gre@includescore{#1}%
}%

\ifdefined\includegabcscore%
	\gre@warning{\protect\includegabcscore\space is deprecated.\MessageBreak Use \protect\includescore\space instead.\MessageBreak Perhaps with the c option.}%
\else%
...
\def\greincludegabcscore#1{%
	\gre@warning{\protect\greincludegabcscore\space is deprecated.\MessageBreak Use \protect\includescore\space instead.\MessageBreak Perhaps with the c option.}%
	\gre@includescore{#1}%
}%
...
\def\gre@includescorewithoption[#1]#2{%
	...
	\else%
		\ifx #1c\relax%
			\directlua{gregoriotex.include_score([[#1]], true)}%
		\else%
			\gre@error{Unrecognized option for \protect\includescore}%
		\fi%
	\fi%
	\relax%
}%
