...
\def\endgre@format@highchoralsign{\endgroup}%

\def\gre@format@firstsyllableinitial{%
  \begingroup%
  \relax%
}%
\def\endgre@format@firstsyllableinitial{\endgroup}%

\def\gre@format@firstsyllable{%
  \begingroup%
  \relax%
}%
\def\endgre@format@firstsyllable{\endgroup}%
