...
% a macro to help typesetting vertical episemus. The third argument is 0 when we go back to the beginning of the glyph. The first argument : if it is not 0 it is the width of which we will have to go back to typeset the episemus, and the second is the type of note it is. It is very hard to understand, sorry.
...
\or%
%case 2
% ^^^^6801 is a kind of flexus, it has the good width
\vepisemusaux{^^^^6801}{\char 17}{0}
\or%
%case 3
% in order to go to the good place, we first make a kern of - the glyph before deminutus, which has the same width as a standard flexus deminutus, that is to say ^^^^3a01
\vepisemusaux{0}{^^^^3a01}{0}
\or%
%case 4
% ^^^^7006 is a torculus, it has the good width
\vepisemusaux{^^^^7006}{\char 17}{0}
\or%
%case 5
% ^^^^7206 is a torculus deminutus, it has the good width
\vepisemusaux{^^^^7206}{\char 17}{0}
\or%
%case 6
\vepisemusaux{0}{\char 17}{1}
\or%
%case 7
\vepisemusaux{0}{\char 13}{1}
\or%
...
\ifcase#2 %
%case 0
\hepisemusaux{\char 17}{40}%
\or%
%case 1
\hepisemusaux{\char 13}{42}%
\or%
%case 2
% ^^^^6801 is a kind of flexus, it has the good width
\hepisemusaux{^^^^6801}{40}%
\or%
%case 3
% in order to go to the good place, we first make a kern of - the glyph before deminutus, which has the same width as a standard flexus deminutus, that is to say ^^^^3a01
\hepisemusaux{^^^^3a01}{40}%
\or%
%case 4
% ^^^^7006 is a torculus, it has the good width
\hepisemusaux{^^^^7006}{40}%
\or%
%case 5
% ^^^^7206 is a torculus deminutus, it has the good width
\hepisemusaux{^^^^7206}{40}%
\or%
%case 6
\hepisemusaux{0}{40}%
\or%
