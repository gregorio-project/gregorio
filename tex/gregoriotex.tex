...
\skipone=\notebarspace %
\ifdim\previousenddifference<0 pt\relax %
\advance\skipone by -\previousenddifference %
\fi %
\advance\skipone by \notebarspace %
\ifdim\nextbegindifference < 0 pt\relax %
\advance\skipone by -\nextbegindifference %
\fi %
...
\fi%
\kern \skipone %
% we add the widht of #1 to the space because, remember, #1 has a special alignment with bars
\setbox\Syllabletext=\hbox{#1}%
% if #1 is not nul, we put #1 in the middle of the last space
\ifdim\wd\Syllabletext= 0 pt%
\else %
% TODO : mettre au milieu des textes ou pas en fait... c'est un peu compliqué...
\divide\skipone by 2 %
\kern -\skipone %
\raise\textlower \copy\Syllabletext %
\kern\skipone %
