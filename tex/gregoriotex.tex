...
% a temporary count
\newcount\tempcount\tempcount=0

% a macro that sets tempcount to the corresponding height value (a => 1, b => 2...)
\def\calculateheightnumber#1{%
\ifx a#1%
\global\tempcount=\number 1%
\fi%
\ifx b#1%
...
%\tempcount=2%
\calculateheightnumber{#1}% sets tempcount to the good value
%\tototo{\the\tempcount}%
\ifodd\tempcount%
\else%
\ifcase#2 %
