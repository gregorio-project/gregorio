...
\def\greinitial#1{%
  ...
  \fi %
  \ifnum\grebiginitial=0\relax%
    \greinitialformat{\global\gre@skip@temp@four = \gre@dimen@beforeinitialshift}%
  \else%
    \grebiginitialformat{\global\gre@skip@temp@four = \gre@dimen@beforeinitialshift}%
  \fi%
  \hskip\gre@skip@temp@four %
  \global\advance\gre@dimen@initialwidth by \gre@skip@temp@four %
  \copy\GreInitial%
  \ifnum\grebiginitial=0\relax%
    \greinitialformat{\global\gre@skip@temp@four = \gre@dimen@afterinitialshift}%
  \else%
    \grebiginitialformat{\global\gre@skip@temp@four = \gre@dimen@afterinitialshift}%
  \fi%
  \hskip\gre@skip@temp@four %
  \global\advance\gre@dimen@initialwidth by \gre@skip@temp@four%
