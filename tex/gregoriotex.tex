...
\ifgreluatex
  ...
  \else
    \ifgreluatextra
      \def\gredirectlua{\luadirect}
    \else
      \def\gredirectlua{\directlua}
    \fi
  \fi
\fi
  
\ifgreluatextra
  \def\greloadluamodule#1{\luaUseModule{#1}}
\else
  \ifgreluatex
...
% this dimention will be the height difference between the two lines above the inital
