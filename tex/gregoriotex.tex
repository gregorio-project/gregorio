...
\or% 3
\advance\tempcount by -1%
\addedraisevalue = 0.05 em %
\or% 4
\advance\tempcount by 1%
\addedraisevalue = -0.04 em%
\fi%
\fi%
\ifx c#1%
\global\tempcount=\number 3%
...
\or%
%case 2
% \char 6801 is a kind of flexus, it has the good width
\vepisemusaux{\char 26625}{\char 17}{1}%
\or%
%case 3
% in order to go to the good place, we first make a kern of - the glyph before deminutus, which has the same width as a standard flexus deminutus, that is to say \char 3a01
\vepisemusaux{0}{\char 14849}{1}%
\or%
%case 4
% \char 7006 is a torculus, it has the good width
\vepisemusaux{\char 28678}{\char 17}{1}%
\or%
%case 5
% \char 7206 is a torculus deminutus, it has the good width
...
% #4 : end of word : if it is 0 it means it is not an end of word, if it is 1 it is, 2 if it is the end of the score
...
\spaceaftersigns=0.09em plus 0.009em minus 0.009em
...
\afterinitialshift=0.6 em plus 0.1em minus 0.1em
...
\font\gregoriantextfont=gregorio at 11pt
