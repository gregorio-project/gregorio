...
\or%
\raise\glyphraisevalue\hbox{\gregorianfont \char 3}%
\fi%
\else % we consider that it is a f key
\ifcase#3%
\raise\glyphraisevalue\hbox{\gregorianfont \char 2}%
\or%
\raise\glyphraisevalue\hbox{\gregorianfont \char 4}%
\fi%
\fi%
}
...
%case 2
% ^^^^6801 is a kind of flexus, it has the good width
\hepisemusaux{^^^^6801}{40}{1}%
\or%
%case 3
% in order to go to the good place, we first make a kern of - the glyph before deminutus, which has the same width as a standard flexus deminutus, that is to say ^^^^3a01
\hepisemusaux{^^^^3a01}{40}{1}%
\or%
%case 4
% ^^^^7006 is a torculus, it has the good width
\hepisemusaux{^^^^7006}{40}{1}%
\or%
%case 5
% ^^^^7206 is a torculus deminutus, it has the good width
\hepisemusaux{^^^^7206}{40}{1}%
\or%
%case 6
\hepisemusaux{0}{40}{0}%
\or%
...
\font\gregoriantextfont=gregorio at \the\factor em
...
\global\gregorianfont=#1 at \the\factor em%
\global\gregoriantextfont=#1 at \the\factor em%
}
