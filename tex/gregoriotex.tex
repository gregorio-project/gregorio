...
\global\multiply\constantglyphraise by \the\factor %
...
\global\multiply\translationheight by \the\factor %
\global\textlower=\spacebeneathtext %
\global\advance\textlower by \translationheight %
}

%macro to call if you wan to go to the next line simply
\def\grenewline{%
%\hfil%
...
\global\multiply\additionaltopspace by \the\factor %
\or % case 3
...
\global\multiply\additionalbottomspace by \the\factor %
\or % case 3
...
\setbox\Initial=\hbox{\raise -\temp\hbox{\fontofinitial #1}}%
\else %
...
\setbox\Initial=\hbox{{\fontofbiginitial #1}}%
\global\initialwidth=\the\wd\Initial %
\setbox\Initial=\hbox{\vbox to 0pt{\hbox{\raise -\temp\hbox{\fontofbiginitial #1}}\vss}}%
\fi %
...
% macro that must be called at each change of linewidth
\def\generatelines{%
...
% a box containig the clef (and the space after)
\newbox\Leftbox
...
\setbox\Leftbox=\hbox{\raise\glyphraisevalue\hbox{\gregorianfont \char 1\hskip\spaceafterlineclef}}%
\or%
