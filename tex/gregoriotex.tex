...
% The primary macro that includes a score.
%
...
\def\includetexscore#1{%
	\gre@warning{\protect\includetexscore\space is deprecated. \MessageBreak Use \protect\includescore[f]\space instead.}%
	\gre@includescorewithoption[f]{#1}%
}%

\def\greincludetexscore#1{%
	\gre@warning{\protect\greincludetexscore\space is deprecated.\MessageBreak Use \protect\includescore[f]\space instead.}%
	\gre@includescorewithoption[f]{#1}%
}%
