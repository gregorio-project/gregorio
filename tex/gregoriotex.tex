...
%% 3: shift when there is a punctum inclinatum after
%% 7: space between a punctum inclinatum and a punctum inclinatum and a punctum inclinatum deminutus
...
\or%
\hskip\punctuminclinatumdebilis2shift %
\fi%
\penalty 10001%
\relax%
}
...
\intersyllablespace=30000 sp plus 2000 sp minus 0 sp
...
% space after at the end of a word when the last written symbol is a note and the first is text TODO : use it
\newskip\interwordspacenotestext
\interwordspacenotestext = 25000 sp plus 2500 sp minus 2500 sp
\multiply\interwordspacenotestext by \factor

% space after at the end of a word when the last written symbol is text and the first is a note TODO : use it
...
\punctuminclinatumdebilisshift=-2500 sp plus 250 sp minus 250 sp
