...
{%
  ...
  \font\local@greciliae = "name:greciliae" at 17 sp\relax %
  \font\local@greextra = "name:greextra" at 17 sp\relax %
  \directlua{gregoriotex.map_font('local@greciliae', 'cp')
             gregoriotex.map_font('local@greextra', 'sp')}%
}%
...
\def\setgregoriofont#1{%
  ...
  {\gregoriofont\directlua{gregoriotex.check_font_version()}}%
  \relax%
}%
