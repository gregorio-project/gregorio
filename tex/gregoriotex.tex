...
%% macro that sets \gre@temp@dimen@three to the width of its argument

\newbox\GreTempwidth%

\def\grewidthof#1{%
  \setbox\GreTempwidth=\hbox{#1}%
  \global\gre@temp@dimen@three=\wd\GreTempwidth%
  \relax%
}%
...
\def\greupdatelinewidth{%
  ...
  \else %
    \gre@temp@dimen@five=\gre@stafflinewidth %
    \global\advance\gre@stafflinewidth by -\gre@additionalleftspace %
    \gregeneratelines %
    \global\gre@stafflinewidth=\gre@temp@dimen@five %
  \fi %
}%
...
\def\greinitial#1{%
  ...
  \gre@temp@dimen@five=-\gre@textlower %
  ...
  \ifnum\grebiginitial=0\relax %
    ...
    \fi%
    \setbox\GreInitial=\hbox to \gre@initialwidth {\hss\raise -\gre@temp@dimen@five\hbox{\greinitialformat{#1}}\hss}%
  \else %
    ...
    \advance\gre@temp@dimen@five by 4\gre@interstafflinespace %
    \advance\gre@temp@dimen@five by 4\gre@stafflineheight %
    ...
    \ifdim\wd\GreAboveinitialsecondbox>\gre@initialwidth\relax%
      \global\gre@initialwidth=\wd\GreAboveinitialsecondbox%
    \fi%
    \setbox\GreInitial=\hbox{\vbox to 0pt{\hbox to \gre@initialwidth {\hss\raise -\gre@temp@dimen@five\hbox{\grebiginitialformat{#1}}\hss}\vss}}%
  \fi %
  \ifnum\grebiginitial=0\relax%
    \greinitialformat{\global\gre@temp@skip@four = \gre@beforeinitialshift}%
  \else%
    \grebiginitialformat{\global\gre@temp@skip@four = \gre@beforeinitialshift}%
  \fi%
  \hskip\gre@temp@skip@four %
  \global\advance\gre@initialwidth by \gre@temp@skip@four %
  \copy\GreInitial%
  \ifnum\grebiginitial=0\relax%
    \greinitialformat{\global\gre@temp@skip@four = \gre@afterinitialshift}%
  \else%
    \grebiginitialformat{\global\gre@temp@skip@four = \gre@afterinitialshift}%
  \fi%
  \hskip\gre@temp@skip@four %
  \global\advance\gre@initialwidth by \gre@temp@skip@four%
  ...
  \else %
    \gre@temp@dimen@five=\gre@initialwidth %
    \advance\gre@temp@dimen@five by -\wd\GreAboveinitialfirstbox  %
    \divide\gre@temp@dimen@five by 2 %
    \gre@temp@skip@four = -\gre@initialwidth%
    \hskip\gre@temp@skip@four %
  ...
  \else %
    \gre@temp@dimen@five=\gre@initialwidth %
    \advance\gre@temp@dimen@five by -\wd\GreAboveinitialsecondbox %
    \divide\gre@temp@dimen@five by 2 %
    \gre@temp@skip@four = -\gre@initialwidth%
    \hskip\gre@temp@skip@four %
    \kern\gre@temp@dimen@five %
...
\def\gretypesettextabovelines#1{%
  \greabovelinestextstyle{\gre@temp@dimen@five=\gre@abovelinestextraise} %
  \advance\gre@temp@dimen@five by 4\gre@stafflineheight %
  \advance\gre@temp@dimen@five by 4\gre@interstafflinespace %
  \advance\gre@temp@dimen@five by \gre@spacebeneathtext %
  \advance\gre@temp@dimen@five by \gre@currenttranslationheight %
  \advance\gre@temp@dimen@five by \gre@spacelinestext %
  \advance\gre@temp@dimen@five by \gre@additionalbottomspace %
  \leavevmode\raise\gre@temp@dimen@five\hbox to 0pt{\greabovelinestextstyle{#1}\hss}%
  \relax %
}%
...
%  \advance\gre@stafflinewidth by -\gre@minimalspaceatlinebeginning
  ...
  \hbox to 0pt{%
    \vbox{%
      ...
      \fi %
      \gre@temp@skip@four = \gre@interstafflinespace%
      \kern\gre@temp@skip@four %
      \ifnum\greremovelinescount=0\relax %
        \hrule height \gre@stafflineheight width \gre@stafflinewidth %
      \else %
...
\def\grewritetranslation#1{%
  ...
  \else %
    \gre@temp@dimen@five=\wd\GreSyllabletext %
    \setbox\GreTempwidth=\hbox{#1}%
...
\def\greinsertchiroline{%
  ...
  \ifnum\greknownline=1\relax %
    ...
    %\grenobreak 
    \gre@temp@skip@four = \gre@belowsignsspace%
    \kern\gre@temp@skip@four %
    %\grenobreak 
    \noindent %
  \else %
    ...
    \grelocalrightbox{}%
    \par %
    \gre@temp@skip@four = \gre@abovesignsspace%
    \kern\gre@temp@skip@four %
...
\def\grenolastline{%
  ...
  \ifdim\gre@enddifference > 0 pt %
    ...
    \ifdim\gre@nextbegindifference > 0 pt %
      \gre@temp@skip@four = \gre@interwordspacenotes%
      \hskip\gre@temp@skip@four %
    \else % (next begin difference >0pt)
      \gre@temp@skip@four = \gre@interwordspacenotestext%
      \hskip\gre@temp@skip@four %
    \fi %
  \else%(enddifference < Opt)
    \gre@debug{ifdim nextbegindifference < 0pt}%
    \ifdim\gre@nextbegindifference < 0 pt %
      \gre@temp@skip@four = \gre@interwordspacetext%
      \hskip\gre@temp@skip@four %
    \else %(next begin difference < 0 pt)
      \gre@temp@skip@four = \gre@interwordspacetextnotes%
      \hskip\gre@temp@skip@four %
    \fi %
  \fi %
...
\def\greendbeforebar#1{%
  ...
  \ifnum#1=1\relax %
    ...
    \ifdim\gre@enddifference > 0 pt %
      \gre@debug{ifdim nextbegindifference > 0pt}%
      \ifdim\gre@nextbegindifference > 0 pt %
        \gre@temp@skip@four = \gre@notebarspace%
        \grehskip\gre@temp@skip@four %
      \else % (next begin difference >0pt)
        \gre@temp@skip@four = \gre@textbartextspace%
        \grehskip\gre@temp@skip@four %
      \fi %
    \else%(enddifference < Opt)
      \gre@debug{ifdim nextbegindifference < 0pt}%
...
\def\greendofelement#1#2{%
  ...
  \fi %
  \ifcase#1%
    \gre@temp@skip@four = \gre@interelementspace%
    \grehskip\gre@temp@skip@four %
  \or% case 1
    \gre@temp@skip@four = \gre@largerspace%
    \grehskip\gre@temp@skip@four %
  \or% case 2
    \gre@temp@skip@four = \gre@glyphspace%
    \grehskip\gre@temp@skip@four %
  \fi%
  \ifnum #2=1\relax %
    \grenobreak %
...
\def\greendofglyph#1{%
  \grenobreak %
  \ifcase#1%
    \gre@temp@skip@four = \gre@interglyphspace%
    \grehskip\gre@temp@skip@four %
  \or% case 1
    \gre@temp@skip@four = \gre@zerowidthspace%
    \grehskip\gre@temp@skip@four %
  \or% case 2
    \gre@temp@skip@four = \gre@alterationspace%
    \grehskip\gre@temp@skip@four %
  \or% case 3
    \gre@temp@skip@four = \gre@punctuminclinatumshift%
    \grehskip\gre@temp@skip@four %
  \or% case 4
    \gre@temp@skip@four = \gre@bitrivirspace%
    \grehskip\gre@temp@skip@four %
  \or% case 5
    \gre@temp@skip@four = \gre@bitristrospace%
    \grehskip\gre@temp@skip@four %
  \or% case 6
    \gre@temp@skip@four = \gre@spaceaftersigns%
    \grehskip\gre@temp@skip@four %
  \or% case 7
    \gre@temp@skip@four = \gre@punctuminclinatumanddebilisshift%
    \grehskip\gre@temp@skip@four %
  \or% case 8
    \gre@temp@skip@four = \gre@punctuminclinatumdebilisshift%
    \grehskip\gre@temp@skip@four %
  \or% case 9
    \gre@temp@skip@four = \gre@beforepunctainclinatashift%
    \grehskip\gre@temp@skip@four %
  \or% case 10
    \gre@temp@skip@four = \gre@punctuminclinatumbigshift%
    \grehskip\gre@temp@skip@four %
  \or% case 11
    \gre@temp@skip@four = \gre@punctuminclinatummaxshift%
    \grehskip\gre@temp@skip@four %
  \fi%
  \grenobreak %
  \relax%
...
\def\setgregoriofont#1{%
  ...
  \gre@temp@count@three = \the\grefactor %
  \multiply\gre@temp@count@three by 100000 %
  \global\font\gregoriofont="name:#1" at \the\gre@temp@count@three sp%
  \relax%
}%
...
\def\gresetstylefont{%
  \gre@temp@count@three = \the\grefactor %
  \multiply\gre@temp@count@three by 100000\relax %
  \global\font\gregoriostylefont="name:greextra" at \the\gre@temp@count@three sp%
  \relax%
}%
