...
\def\grecalculateconstantglyphraise{%
  ...
  \global\advance\greconstantglyphraise by \grestafflineheight %
  \global\advance\greconstantglyphraise by \gretranslationheight %
  \relax %
}
...
\def\greaddtranslationspace{%
  \global\gretranslationheight=60000 sp%
  \global\multiply\gretranslationheight by \the\grefactor %
...
\def\greremovetranslationspace{%
  \global\gretranslationheight=0 sp%
  \global\gretextlower=\grespacebeneathtext %
  \gregeneratelines %
  \grecalculateconstantglyphraise %
  \relax %
...
\def\greinitial#1{%
  ...
  \else %
    ...
    \setbox\GreInitial=\hbox{\gregrebiginitialformat{#1}}%
    \global\greinitialwidth=\the\wd\GreInitial %
    \setbox\GreInitial=\hbox{\vbox to 0pt{\hbox{\raise -\gretempdim\hbox{\gregrebiginitialformat{#1}}}\vss}}%
  \fi %
...
\def\gresetaboveinitialraise{%
  ...
  \global\advance\greaboveinitialfirstraise by \gretranslationheight %
...
\newdimen\greabovelinestextraise % raises the text above the note line
\newdimen\greabovelinestextwidth % used for kerning to ``reset'' spacing
\newbox\GreAbovelinestextbox % box for the text above

% set space above the text lines - almost the same as for the translation
\def\greaddspaceabove{%
  \global\greabovelinestextraise=60000 sp%
  \global\multiply\greabovelinestextraise by \the\grefactor %
  %\global\advance\grespaceabovelines by \greabovelinestextraise %
  \gregeneratelines %
  \grecalculateconstantglyphraise %
  \global\advance\greabovelinestextraise by 4\grestafflineheight %
  \global\advance\greabovelinestextraise by 4\greinterstafflinespace %
  \relax %
}

% we don't need space above any more
\def\greremovespaceabove{%
  \global\greabovelinestextraise=0 sp%
  \gregeneratelines %
  \grecalculateconstantglyphraise %
  \relax %
}
...
\def\greabovelinestext#1{%
  \setbox\GreAbovelinestextbox\hbox{\greabovelinestextstyle{#1}}
  \leavevmode\raise\greabovelinestextraise\copy\GreAbovelinestextbox%
  \global\greabovelinestextwidth=\wd\GreAbovelinestextbox%
  \kern-\greabovelinestextwidth%
}
