...
{%
  \directlua{gregoriotex.init_variant_font('greciliae')}%
...
\def\setgregoriofont#1{%
  ...
  {\gregoriofont\directlua{gregoriotex.check_font_version() gregoriotex.scale_variant_fonts([[\the\gre@count@temp@three]])}}%
  \relax%
}%
...
\def\gredefvariant#1#2#3{%
  \directlua{gregoriotex.init_variant_font([[#2]])}%
  \directlua{gregoriotex.set_glyph([[#1]],[[#2]],[[#3]])}%
}%
...
\def\grechangeglyph#1#2#3{%
  \directlua{gregoriotex.init_variant_font([[#2]])}%
  \directlua{gregoriotex.change_glyph([[#1]],[[#2]],[[#3]])}%
}%

% Resets a gregorio code point to its default setting
% #1 = the name of the gregorio code point
\def\greresetglyph#1{%
  \directlua{gregoriotex.reset_glyph([[#1]])}%
}%
