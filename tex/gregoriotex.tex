...
% Since small caps in PlainTeX requires loading another font, which we do here for the default Computer Modern font.  We assume that a user choosing another font will know to do that on their own.
\font\sc=cccsc10 at \f@size pt
\def\GreSmallCaps#1{%
  {\sc #1}%
  \relax %
}%
