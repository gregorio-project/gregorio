...
\or%
%case 1
% in order to go to the good place, we first make a kern of - half a punctum deminutus
\setbox\Tempsign=\hbox{\gregorianfont \char 13}%
\tempwidth=\wd\Tempsign%
% we set tempwidth to the middle of one note
\divide\tempwidth by 2 %
% then we draw the sign, and go back to the beginning of the sign
...
\setbox\Tempsign=\hbox{\gregorianfont ^^^^6801}%
\tempwidth=\wd\Tempsign %
\setbox\Tempsign=\hbox{\gregorianfont \char 17}%
\tempsignwidth=\wd\Tempsign%
\divide\tempsignwidth by 2 %
...
\setbox\Tempsign=\hbox{\gregorianfont ^^^^3a01}%
\tempwidth=\wd\Tempsign%
% we set tempwidth to the middle of one note
\divide\tempwidth by 2 %
% then we draw the sign, and go back to the beginning of the sign
...
\kern \tempwidth%
\or%
%case 6, in which we do (for now) the same as case 5
\setbox\Tempsign=\hbox{\gregorianfont \char 17}%
\tempsignwidth=\wd\Tempsign%
\divide\tempsignwidth by 2 %
\advance\tempwidth by -\tempsignwidth %
