...
\global\spaceabovelines = 25000 sp plus 60000 sp minus 0 sp%
\global\multiply\spaceabovelines by \grefactor %
\global\spacelinestext = 59500 sp plus 0 sp minus 0 sp%
\global\multiply\spacelinestext by \grefactor %
\global\spacebeneathtext = 18000 sp plus 0 sp minus 0 sp%
\global\multiply\spacebeneathtext by \grefactor %
...
\global\translationheight=80000 sp%
...
%% 2: iden, but with the bottom line (-1th)
\def\grenewlinewithspace#1#2{%
...
\raise\spacebeneathtext\hbox to 0pt{{\translationfont #1}\hss}%
\relax %
}
...
\unkern %
\hbox{\copy\Leftbox\hskip\afterclefnospace}%
}%
}
...
\setgrespaces %
\generatelines %
\setgregorianfont{greciliae}% TODO : change it, so that users can choose without changin the factor
\relax %
}
