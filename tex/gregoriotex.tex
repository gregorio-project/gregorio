...
\raise\glyphraisevalue\hbox{\gregoria \char 1}%
\else % we consider that it is a f key
\raise\glyphraisevalue\hbox{\gregoria \char 2}%
\fi%
}
...
\raise\glyphraisevalue\hbox{\gregoria \char 8}%
\hskip\barspace %
\penalty 0% test
}
...
\hskip\barspace %
\calculateglyphraisevalue{8}% bar glyphs are made to be at this height
\raise\glyphraisevalue\hbox{\gregoria \char 9}%
\hskip\barspace %
}
...
\hskip\barspace %
\calculateglyphraisevalue{8}% bar glyphs are made to be at this height
\raise\glyphraisevalue\hbox{\gregoria \char 10}%
\hskip\barspace %
}
...
\hskip\barspace %
\calculateglyphraisevalue{8}% bar glyphs are made to be at this height
\raise\glyphraisevalue\hbox{\gregoria \char 11}%
\hskip\barspace %
}
