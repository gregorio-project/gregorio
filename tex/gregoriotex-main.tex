...
\def\greinitial#1{%
  ...
  \ifnum\grebiginitial=0\relax %
    \setbox\GreInitial=\hbox{\gre@format@initial\greinitialformat{#1}\endgre@format@initial}%
    ...
    \fi%
    \setbox\GreInitial=\hbox to \gre@dimen@initialwidth {\hss\raise -\gre@dimen@temp@five\hbox{\gre@format@initial\greinitialformat{#1}\endgre@format@initial}\hss}%
  \else %
    ...
    \setbox\GreInitial=\hbox{\gre@format@biginitial\grebiginitialformat{#1}\endgre@format@biginitial}%
    \gre@debugmsg{ifdim}{ manualinitialwidth = 0pt}%
    \ifdim\gre@dimen@manualinitialwidth=0 pt\relax%
      \global\gre@dimen@initialwidth=\wd\GreInitial %
    \else%
      \gre@format@biginitial%
      \grebiginitialformat{\global\gre@dimen@initialwidth=\gre@dimen@manualinitialwidth}%
      \endgre@format@biginitial%
    \fi%
    \gre@debugmsg{ifdim}{ wd(GreAboveinitialfirstbox) > initialwidth}%
    \ifdim\wd\GreAboveinitialfirstbox>\gre@dimen@initialwidth\relax%
      \global\gre@dimen@initialwidth=\wd\GreAboveinitialfirstbox%
    ...
    \ifdim\wd\GreAboveinitialsecondbox>\gre@dimen@initialwidth\relax%
      \global\gre@dimen@initialwidth=\wd\GreAboveinitialsecondbox%
    \fi%
    \setbox\GreInitial=\hbox{\vbox to 0pt{\hbox to \gre@dimen@initialwidth {\hss\raise -\gre@dimen@temp@five\hbox{\gre@format@biginitial\grebiginitialformat{#1}\endgre@format@biginitial}\hss}\vss}}%
  \fi %
  \ifnum\grebiginitial=0\relax%
    \gre@format@initial%
...
\def\gretypesettextabovelines#1{%
  ...
  \advance\gre@dimen@temp@five by \gre@dimen@additionalbottomspace %
  \gre@debugmsg{spacing}{Raise alt text: \the\gre@dimen@temp@five}%
  \leavevmode\raise\gre@dimen@temp@five\hbox to 0pt{\gre@format@abovelinestext\greabovelinestextstyle{#1}\endgre@format@abovelinestext\hss}%
  \relax %
}%
...
\def\grewritetranslation#1{%
  \ifnum\gretranslationcenteringscheme=0\relax %
    \raise\gre@dimen@spacebeneathtext\hbox to 0pt{\vbox to 0pt{\vss\hbox to 0pt{\gre@format@translation\gretranslationformat{#1}\endgre@format@translation\hss}}}%
  \else %
    ...
    \kern\gre@dimen@temp@five %
    \raise\gre@dimen@spacebeneathtext\hbox to 0pt{\vbox to 0pt{\vss\hbox to 0pt{\gre@format@translation\gretranslationformat{#1}\endtranslationformat\hss}}}%
    \kern-\gre@dimen@temp@five %
  \fi %
}%
...
\def\grewritetranslationwithcenterbeginning#1{%
  ...
  \raise\gre@dimen@spacebeneathtext\hbox to 0pt{\kern 0pt\vbox to 0pt{\vss\hbox to 0pt{\gre@format@translation\gretranslationformat{#1}\endtranslationformat\hss}}\kern 0pt}%
...
\def\GreSetStaffLinesFormat#1{%
  \gre@warning{\protect\GreSetStaffLinesFormat\space is deprecated.\MessageBreak Use \protect\grechangeformat{normalstafflines} instead.}
  \gre@changeformat{normalstafflines}{#1}[\relax]%
  \relax %
}%
...
\def\grechangeformat#1#2{%
  \@ifnextchar[%
    \gre@changeformat{#1}{#2}%
  \else%
    \gre@changeformat{#1}{#2}[\relax]%
  \fi%
}%
