  ...
  \ifgre@showlyrics%
    \ifcase#3\relax% no forced center: honor the centering mode
      \ifcase\gre@lyriccentering% 0 - syllable centering
        \def\gre@stackedlyric@firstpart{}%
        \def\gre@stackedlyric@middlepart{#4#5#6}%
        \def\gre@stackedlyric@endpart{}%
      ...
      \or% 2 - first-letter centering
        \def\gre@stackedlyric@firstpart{}%
        \def\gre@stackedlyric@middlepart{#7}%
        \def\gre@stackedlyric@endpart{#8}%
      \fi%
    \else% forced center
      \def\gre@stackedlyric@firstpart{#4}%
      \def\gre@stackedlyric@middlepart{#5}%
    ...
    \gre@widthof{\gre@stackedlyric@firstpart\gre@stackedlyric@middlepart}%
    \gre@dimen@stackedlyriccenter=\gre@dimen@temp@three%
    \gre@widthof{\gre@stackedlyric@middlepart}%
    \divide\gre@dimen@temp@three by 2\relax%
    \advance\gre@dimen@stackedlyriccenter by -\gre@dimen@temp@three%
