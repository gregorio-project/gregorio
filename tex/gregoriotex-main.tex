...
\def\gre@unsetattr@dash{\unsetluatexattribute{\gre@attr@dash}}%
...
\def\GreBeginNLBArea#1#2{%
  \xdef\gre@nlbintialstate{\gre@nlbstate}%
  \ifnum#2=0\relax %
    \xdef\gre@nlbstate{2}%
  \else %
      \ifcase\gre@nlbstate %
      ...
      \fi %
  \fi %
  \ifnum\gre@nlbintialstate=0\relax %
...
\def\GreEndNLBArea#1#2{%
  ...
  \ifnum\gre@nlbstate=0\relax %
    \ifnum\gre@nlbintialstate=0\else %
...
\def\gre@loadgregoriofont{%
  ...
  \global\font\gregoriofont={name:\gre@gregoriofontname} at \the\gre@count@temp@three sp%
