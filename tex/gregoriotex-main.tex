...
% Typesets one additional lyric line (level 2+): resolves its stashed
% fields and hands them to \GreWriteStackedLyric below.
% #1: level (2 for the first additional line)
\def\gre@buildstackedlyriclevel#1{%
  \GreWriteStackedLyric{#1}%
    {\csname gre@stackedlyric@level@#1@eow\endcsname}%
...
\newdimen\gre@dimen@enddifference@textwidth%
  ...
  \ifnum\gre@count@stackedlyriclevels>1\relax
    ...
    \loop
      ...
      \gre@dispatchlevelcentering
        {\csname gre@stackedlyric@level@\the\gre@count@stackedlyricloop @forced\endcsname}%
        {\csname gre@stackedlyric@level@\the\gre@count@stackedlyricloop @pre\endcsname}%
        {\csname gre@stackedlyric@level@\the\gre@count@stackedlyricloop @mid\endcsname}%
        {\csname gre@stackedlyric@level@\the\gre@count@stackedlyricloop @post\endcsname}%
        {\csname gre@stackedlyric@level@\the\gre@count@stackedlyricloop @first\endcsname}%
        {\csname gre@stackedlyric@level@\the\gre@count@stackedlyricloop @rest\endcsname}%
      \gre@measureoverhang
        {\gre@fixedtextformat{\gre@stackedlyric@firstpart\gre@stackedlyric@middlepart}}%
        {\gre@fixedtextformat{\gre@stackedlyric@middlepart}}%
        {\gre@fixedtextformat{\gre@stackedlyric@endpart}}%
...
\def\GreWriteStackedLyric#1#2#3#4#5#6#7#8{%
  \ifgre@showlyrics%
    ...
    % (same \gre@fixedtextformat wrap as level 1)
