...
\def\gre@annotation[#1]#2{%
  ...
  \ifvoid\gre@box@annotation%
    ...
    \or %case 1 = baseline of first line
      \global\gre@dimen@annotationtrueraise= \ht\gre@box@annotation@add\relax%
    ...
    \or %case 2 = bottom of first line
      \global\gre@dimen@annotationtrueraise=\dimexpr\ht\gre@box@annotation@add+\dp\gre@box@annotation@add\relax%
  ...
  \else%
    ...
    \ifgre@annotationbottomline%
      ...
      \or %case 1 = baseline of first line
        \global\gre@dimen@annotationtrueraise=\dimexpr\ht\gre@box@annotation@old+\dp\gre@box@annotation@old+\gre@dimen@annotationseparation+\ht\gre@box@annotation@add%
        \gre@debugmsg{annotation}{Aligning to baseline of last line: \the\gre@dimen@annotationtrueraise}%
      \or %case 2 = bottom of first line
        \global\gre@dimen@annotationtrueraise=\dimexpr\ht\gre@box@annotation@old+\dp\gre@box@annotation@old+\gre@dimen@annotationseparation+\ht\gre@box@annotation@add+\dp\gre@box@annotation@add\relax%
        \gre@debugmsg{annotation}{Aligning to bottom of last line: \the\gre@dimen@annotationtrueraise}%
      \else% Bug
        \gre@bug{Invalid value for \protect\gre@count@annotationvalign}%
      \fi%
    \fi%
    % A manual fudge factor in the spread is needed so get annotation lines to actually touch when annotationspearation is 0.
    \setbox\gre@box@annotation = \hbox to \gre@dimen@temp@three{\vtop spread \dimexpr -0.1em +\gre@dimen@annotationseparation\relax{{\offinterlineskip\noindent\box\gre@box@annotation@old\vss\noindent\box\gre@box@annotation@add}}}%
  \fi%
}%
