...
\def\greinitial#1{%
  ...
  \ifnum\grebiginitial=0\relax %
    \setbox\GreInitial=\hbox{\gre@style@initial\greinitialformat{#1}\endgre@style@initial}%
  ...
  \else %
    ...
    \setbox\GreInitial=\hbox{\gre@style@biginitial\grebiginitialformat{#1}\endgre@style@biginitial}%
    \gre@debugmsg{ifdim}{ manualinitialwidth = 0pt}%
    \ifdim\gre@dimen@manualinitialwidth=0 pt\relax%
      \global\gre@dimen@initialwidth=\wd\GreInitial %
    \else%
