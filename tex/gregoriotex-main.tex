...
\def\grecommentary#1{%
  \ifvoid\gre@box@commentary%
    \setbox\gre@box@commentary = \hbox{\gre@style@commentary#1\endgre@style@commentary}%
  \else%
    \gre@widthof{\gre@style@commentary#1\endgre@style@commentary}%
    ...
    \setbox\gre@box@add = \hbox to \gre@dimen@temp@three{\hfill\gre@style@commentary#1\endgre@style@commentary}%
