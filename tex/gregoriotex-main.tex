...
\def\grechangestyle#1#2{%
  \IfStrEq{#1}{biginitial}{\gre@obsolete{biginitial style}{initial style}}{}%%% DEPRECATED for removal in 5.0
...
\long\def\gre@gabcsnippet@option[#1]#2{%%% DEPRECATED by 4.1
  \gre@obsolete{\protect\gabcsnippet  with initial-style argument}{\protect\gresetinitiallines}%
