...
\def\gre@typesettextabovelines#1#2#3{%
  ...
  \else%
    ...
    \raise\gre@dimen@temp@five\hbox to 0pt{%
      \ifnum\gre@count@temp@one>1\relax% center (2) or right (3): align
                                        % within the width of the anchor glyph
        \hbox to \gre@dimen@lastglyphwidth{\hss
          \gre@style@abovelinestext
            \gre@applyphantomwrapper{\gre@abovelinestext@phantomwrapper}{#2}%
          \endgre@style@abovelinestext
          \ifnum\gre@count@temp@one=2\relax\hss\fi}%
      \else% left: flush against the anchor point
        \gre@style@abovelinestext
          \gre@applyphantomwrapper{\gre@abovelinestext@phantomwrapper}{#2}%
        \endgre@style@abovelinestext
      \fi%
