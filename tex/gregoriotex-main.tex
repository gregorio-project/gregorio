...
% 9 = annotation, 10 = notes, 11 = syllable-final penalty
...
% 2 = between syllable left and text left
% 3 = between text right and notes left
% 4 = between notes right and syllable right
% 5 = clearsyllable
\newattribute\gre@attr@skip@type

% attribute for special notes
% 1 = punctum mora (including spacebeforesigns)
% 2 = bar (including space before and after)
% 3 = custos (including space and alteration)
\newattribute\gre@attr@note@type
  ...
  \ifgre@boxing\else%
    \ifnum#2=0\relax %
      ...
      \ifgre@eolshiftsenabled%
        ...
        % bug: if the break occurs between notes, like (gzg), the enddifference is wrong (#1738)
