...
\xdef\gre@gregoriotexversion{5.0.0-beta1}% GREGORIO_VERSION - VersionManager.py
...
\def\gre@loadgregoriofont{%
  ...
  \fi %
  \directlua{gregoriotex.check_font_version() gregoriotex.scale_score_fonts([[\the\gre@count@temp@three]], [[\the\gre@factor]])}%
  \relax%
}%
