...
\def\GreSetInitial#1{%
  ...
  % we print the initial always at the same place, and the we print the gre@box@firstaboveinitial, centered
  ...
  \ifnum\grebiginitial=0\relax %
    \setbox\gre@box@initial=\hbox{\greinitialformat{#1}}%
    ...
    \fi%
    \gre@debugmsg{ifdim}{ wd(gre@box@firstaboveinitial) > initialwidth}%
    \ifdim\wd\gre@box@firstaboveinitial>\gre@dimen@initialwidth\relax%
      \global\gre@dimen@initialwidth=\wd\gre@box@firstaboveinitial%
    \fi%
    \gre@debugmsg{ifdim}{ wd(gre@box@secondaboveinitial) > initialwidth}%
    \ifdim\wd\gre@box@secondaboveinitial>\gre@dimen@initialwidth\relax%
      \global\gre@dimen@initialwidth=\wd\gre@box@secondaboveinitial%
    \fi%
    \setbox\gre@box@initial=\hbox to \gre@dimen@initialwidth {\hss\raise -\gre@dimen@temp@five\hbox{\greinitialformat{#1}}\hss}%
  \else %
    ...
    \setbox\gre@box@initial=\hbox{\grebiginitialformat{#1}}%
    \gre@debugmsg{ifdim}{ manualinitialwidth = 0pt}%
    \ifdim\gre@dimen@manualinitialwidth=0 pt\relax%
      \global\gre@dimen@initialwidth=\wd\gre@box@initial %
    \else%
    ...
    \ifdim\wd\gre@box@secondaboveinitial>\gre@dimen@initialwidth\relax%
      \global\gre@dimen@initialwidth=\wd\gre@box@secondaboveinitial%
    \fi%
    \setbox\gre@box@initial=\hbox{\vbox to 0pt{\hbox to \gre@dimen@initialwidth {\hss\raise -\gre@dimen@temp@five\hbox{\grebiginitialformat{#1}}\hss}\vss}}%
  \fi %
  \ifnum\grebiginitial=0\relax%
  ...
  \gre@debugmsg{ifdim}{ wd(gre@box@firstaboveinitial) = 0pt}%
  \ifdim\wd\gre@box@firstaboveinitial=0 pt\relax %
  \else %
    \gre@dimen@temp@five=\gre@dimen@initialwidth %
    \advance\gre@dimen@temp@five by -\wd\gre@box@firstaboveinitial%
    \divide\gre@dimen@temp@five by 2 %
    \gre@skip@temp@four = -\gre@dimen@initialwidth%
    \hskip\gre@skip@temp@four %
    \kern\gre@dimen@temp@five %
    \raise\gre@dimen@aboveinitialfirstraise\copy\gre@box@firstaboveinitial%
    \kern\gre@dimen@temp@five %
    \setbox\gre@box@firstaboveinitial=\hbox{}%
  \fi %
  % then we center the second box above the initial, if there is one
  \gre@debugmsg{ifdim}{ wd(gre@box@secondaboveinitial) = 0pt}%
  \ifdim\wd\gre@box@secondaboveinitial=0 pt\relax %
  \else %
    \gre@dimen@temp@five=\gre@dimen@initialwidth %
    \advance\gre@dimen@temp@five by -\wd\gre@box@secondaboveinitial %
    \divide\gre@dimen@temp@five by 2 %
    \gre@skip@temp@four = -\gre@dimen@initialwidth%
    \hskip\gre@skip@temp@four %
    \kern\gre@dimen@temp@five %
    \raise\gre@dimen@aboveinitialsecondraise\copy\gre@box@secondaboveinitial %
    \kern\gre@dimen@temp@five %
    \setbox\gre@box@secondaboveinitial=\hbox{}%
  \fi %
  \relax %
}%
...
\newbox\gre@box@firstaboveinitial%
\newbox\gre@box@secondaboveinitial%
...
\def\gresetfirstlineaboveinitial#1#2{%
  ...
  \setbox\gre@box@firstaboveinitial=\hbox{#2}%
  \global\gre@dimen@aboveinitialfirstraise=-\ht\gre@box@firstaboveinitial %
  \global\setbox\gre@box@firstaboveinitial=\hbox{#1}%
  \relax %
}%
...
\def\gresetsecondannotation#1{%
  \setbox\gre@box@secondaboveinitial=\hbox{#1}%
  \global\gre@dimen@aboveinitialsecondraise=-\ht\gre@box@secondaboveinitial %
...
\def\GreMode#1{%
  \ifhbox \gre@box@firstaboveinitial%
    \relax%
  \else%
    \ifcase#1%
    \or%
...
\def\GreBeginScore{%
  ...
  \GreSetGregorioFont{\gregoriofontname}%
...
\def\grenobreakineuouae{%
  \gre@euouae@implies@nlbatrue %
}

\def\greallowbreakineuouae{%
...
\def\GreSetStaffLinesFormat#1{%
  \gre@warning{\protect\GreSetStaffLinesFormat\space is deprecated.\MessageBreak Use \protect\gresetstafflinesformat\space instead.}%
  \gresetstafflinesformat{#1}%
}%
...
\def\GreUseNormalHyphen{%
  \gre@warning{\protect\GreUseNormalHyphen\space is deprecated.\MessageBreak Use \protect\greusenormalhyphen\space instead.}%
  \greusenormalhyphen%
}%
...
\def\GreUseZeroHyphen{%
  \gre@warning{\protect\GreUseZeroHyphen\space is deprecated.\MessageBreak Use \protect\greusezerohyphen\space instead.}%
  \greusezerohyphen%
}%
...
% macro to revert to hyphenation based on space
\def\greautohyphen{
