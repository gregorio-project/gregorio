...
\def\gre@setinitial#1{%
  ...
  \else %
    \ifgre@allowdeprecated%%% DEPRECATED for removal in 5.0
      \gre@warning{biginitial style is deprecated, but the old behavior will be used since deprecated usage is currently enabled.  This behavior will disappear in 5.0, so consider disabling deprecated usage and switching to the initial style instead.  See UPGRADE.md for more information.}%%% DEPRECATED for removal in 5.0
