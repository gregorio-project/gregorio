...
% firsttop (0) = top of first line
% lastbaseline (1) = baseline of last indented line
% lastbottom (2) = bottom of last indented line
\def\gresetinitialposition#1{%
  \IfStrEqCase{#1}{%
    {firsttop}{\gre@count@initialposition=0}%
    {lastbaseline}{\gre@count@initialposition=1}%
    {lastbottom}{\gre@count@initialposition=2}%
  }[%
...
\def\gre@setinitial#1{%
  ...
  % Set the initial. We smash it so it doesn't disrupt anything, in
  % particular the glue between lines.
