...
\newluatexattribute\gre@attr@score@id\setluatexattribute\gre@attr@score@id{0}%
...
\def\GreBeginScore{%
  \global\advance\gre@attr@score@id by 1\relax %
  ...
  \gregeneratelines %
  \noindent%
  \directlua{gregoriotex.atScoreBeginning() gregoriotex.adjust_line_height()}%
