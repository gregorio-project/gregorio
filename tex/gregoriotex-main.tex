...
\def\gre@loadgregoriofont{%
  ...
  \global\font\gre@font@neumebase={name:\gre@gregoriofontname} at \the\gre@count@temp@three sp%
  {\gre@font@neumebase\directlua{gregoriotex.check_font_version() gregoriotex.scale_score_fonts([[\the\gre@count@temp@three]])}}%
  \relax%
}%
