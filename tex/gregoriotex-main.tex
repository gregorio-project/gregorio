...
\def\GreNewLine{%
  \gre@debugmsg{general}{GreNewLine}%
...
\def\GreNewLineWithSpace#1#2#3#4{%
  \gre@debugmsg{general}{GreNewLineWithSpace #1 #2}%
...
%macro to call if you want to go to the next line simply
\def\GreNewParLine{%
  \gre@debugmsg{general}{GreNewParLine}%
  \grenewlinecommon{0}{0}{0}{1}{0}%
  \relax%
}%

\def\GreNewParLineWithSpace#1#2#3#4{%
  \gre@debugmsg{general}{GreNewParLineWithSpace #1 #2}%
...
\newcount\gre@variableheightexpansion\gre@variableheightexpansion=0\relax %
