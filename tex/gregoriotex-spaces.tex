...
\def\gre@calculate@commentarytrueraise{%
  ...
  \global\gre@dimen@commentarytrueraise = \dimexpr\gre@dimen@staffheight + \gre@dimen@spacebeneathtext + \gre@dimen@currenttranslationheight + \gre@dimen@spacelinestext +  \gre@dimen@additionalbottomspace + \gre@dimen@commentaryraise\relax%
}%
