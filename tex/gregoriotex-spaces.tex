...
\newdimen\gre@dimen@lineskip@save%
\newdimen\gre@dimen@baselineskip@save%
\newdimen\gre@dimen@lineskiplimit@save%
...
\def\gre@cancelpenalties{%
  ...
  \global\gre@dimen@lineskip@save=\lineskip%
  \global\gre@dimen@baselineskip@save=\baselineskip%
  \global\gre@dimen@lineskiplimit@save=\lineskiplimit%
  ...
  \lineskip=\gre@space@dimen@lineskip%
  \baselineskip=\gre@space@dimen@baselineskip%
  \lineskiplimit=\gre@space@dimen@lineskiplimit%
}%
...
\def\gre@restorepenalties{%
  ...
  \lineskip=\gre@dimen@lineskip@save%
  \baselineskip=\gre@dimen@baselineskip@save%
  \lineskiplimit=\gre@dimen@lineskiplimit@save%
}%
...
\def\gre@rubberpermit#1{%
  ...
  \IfStrEqCase*{#1}{%
    ...
    {lineskip}{\gre@rubberfalse}%
    {baselineskip}{\gre@rubberfalse}%
    {lineskiplimit}{\gre@rubberfalse}%
  }[\gre@rubbertrue]%
}%
