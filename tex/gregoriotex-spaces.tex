...
\def\gre@calculate@additionalspaces#1#2{%
  \gre@debugmsg{lineheight}{gre@calculate@additional@spaces called with #1 #2}%
  \gre@count@temp@one=#1\relax %
  \advance\gre@count@temp@one by -\gre@pitch@j\relax %
...
\def\GreFirstLineBottomSpace#1#2{%
  \gre@debugmsg{lineheight}{GreFirstLineBottomSpace #1 #2}%
  \ifcase\gre@variableheightexpansion %
    % 0
    \gre@calculate@bottomspace{#1}%
...
\def\gre@calculate@bottomspace#1{%
  \gre@count@temp@one=#1\relax %
  \advance\gre@count@temp@one by -\gre@pitch@c\relax %
