...
\gre@declarefileversion{gregoriotex-spaces.tex}{4.1.0-beta1}% GREGORIO_VERSION
...
\def\gre@rubberpermit#1{%
  ...
  \IfStrEq{#1}{commentaryseparation}{\gre@rubberfalse}{\relax}%
  ...
  \IfStrEq{#1}{maxbaroffset}{\gre@rubberfalse}{\relax}%
}%
...
\def\gre@changedimenfactor#1#2{%
  ...
  \fi%
  \ifgre@scale@maxbaroffset%
    \gre@changeonedimenfactor{maxbaroffset}{#1}{#2}%
  \fi%
