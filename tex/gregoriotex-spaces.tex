...
\def\greadaptconfvalues{%
  ...
  \greadaptoneconfvalue{\clefflatspace}%
  ...
  \greadaptoneconfvalue{\greafterinitialshift}%
  \greadaptoneconfvalue{\greafterinitialshift}%
  \greadaptoneconfvalue{\grestafflineheight}%
  \greadaptoneconfvalue{\greinterstafflinespace}%
  \greadaptoneconfvalue{\grespaceabovelines}%
  \greadaptoneconfvalue{\grespacelinestext}%
  \relax %
}

\edef\greadaptoneconfvalue#1{%
  \multiply #1 by \the\grefactor %
  \relax %
}
