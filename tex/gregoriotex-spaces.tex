...
\gre@declarefileversion{gregoriotex-spaces.tex}{3.0.0-rc2}% GREGORIO_VERSION
...
% #1 is 1, 2, 3, or 4, with the same signification as in grenewlinewithspace
...
\def\gre@rubberpermit#1{%
  ...
  \IfStrEq{#1}{lowchoralsignshift}{\rubberfalse}{\relax}%
  \IfStrEq{#1}{highchoralsignshift}{\rubberfalse}{\relax}%
...
\def\gre@changedimenfactor#1#2{%
  ...
  \fi%
  \ifnum\gre@scale@beforechoralsignspace=1\relax%
  ...
  \fi%
  \ifnum\gre@scale@intersyllablespace=1\relax%
  ...
  \fi%
  \ifnum\gre@scale@interwordspacenotestext=1\relax%
    \gre@changeonedimenfactor{interwordspacenotestext}{#1}{#2}%
  \fi%
  \ifnum\gre@scale@interwordspacetextnotes=1\relax%
  ...
  \fi%
  \ifnum\gre@scale@lowchoralsignshift=1\relax%
    \gre@changeonedimenfactor{lowchoralsignshift}{#1}{#2}%
  \fi%
  \ifnum\gre@scale@highchoralsignshift=1\relax%
