...
\def\gre@rubberpermit#1{%
  ...
  \IfStrEqCase*{#1}{%
    ...
    {baroffsetadditionalspacearoundbars}{\gre@rubberfalse}%
...
\def\gre@changedimenfactor#1#2{%
  ...
  \fi%
  \ifgre@scale@baroffsetadditionalspacearoundbars%
    \gre@changeonedimenfactor{baroffsetadditionalspacearoundbars}{#1}{#2}%
  \fi%
