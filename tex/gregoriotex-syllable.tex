...
\def\GreGlyph#1#2#3#4#5#6{%
  \grenewglyphcommon %
  \setbox\gre@box@temp@width=\hbox{\gregoriofont #1}%
...
\def\defaultcentering{%
  \gre@warning{\protect\englishcentering\space is deprecated.\MessageBreak Use \protect\gresetlyriccentering{vowel} instead}%
  ...
  \ifcase#4 %
    ...
    \ifdim\gre@skip@temp@one > \gre@dimen@maximumspacewithoutdash %
      ...
      \ifnum\grelastoflinecount=1\relax %
        \setbox\gre@box@syllabletext=\hbox{\grefixedtextformat{\gre@firstsyllablepart\gre@middlesyllablepart\gre@endsyllablepart\GreHyph\relax}}%
      \else %
        \setbox\gre@box@syllabletext=\hbox{\grefixedtextformat{\gre@firstsyllablepart\gre@middlesyllablepart\gre@endsyllablepart-}}%
      \fi %
