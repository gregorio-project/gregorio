...
\def\grebarsyllable#1#2#3#4#5#6#7#8#9{%
	...
	\ifdim\wd\GreSyllabletext = 0 pt\relax %
		...
		\ifdim\gre@nextbegindifference < 0 pt%
			\gre@temp@skip@two=-\gre@nextbegindifference %
		\else %
			\gre@temp@skip@two=0 pt%
		\fi %
		\gre@debug{ifdim previousenddifference < 0pt}%
		\ifdim\gre@previousenddifference < 0 pt%
			\advance\gre@temp@skip@two by -\gre@previousenddifference %
			\advance\gre@temp@skip@two by \gre@interwordspacetext % in fact it is the max between interwordspacetext and interwordspacetextnotes
		\else %
			\advance\gre@temp@skip@two by \gre@interwordspacenotestext % in fact it is the max between interwordspacenotestext and interwordspacenotes
		\fi%
		...
		\ifdim\gre@temp@skip@three <\gre@temp@skip@two %
			\gre@temp@skip@three=\gre@temp@skip@two %
		\fi %
		...
		\gre@temp@skip@two=\gre@temp@skip@three %
		\gre@debug{ifdim previousenddifference < 0pt}%
		\ifdim\gre@previousenddifference < 0 pt%
			\advance\gre@temp@skip@two by \gre@previousenddifference %
		\fi %
		...
		\ifdim\gre@temp@skip@two > -\wd\GreSyllablenotes %
			\kern\gre@temp@skip@two %
		\else %
		...
		\else 
			%\ifdim\gre@temp@skip@two < -\wd\GreSyllablenotes
				%\gre@temp@skip@two=\wd\GreSyllablenotes 
				%\divide\gre@temp@skip@two by 2\relax 
				%\kern -\gre@temp@skip@two 
			\gre@temp@skip@two=\gre@temp@skip@three %
			\gre@debug{ifdim nextbegindifference < 0pt}%
			\ifdim\gre@nextbegindifference < 0 pt%
				\advance\gre@temp@skip@two by \gre@nextbegindifference %
			\fi %
			\gre@debug{ifdim temp@skip@two > -wd(GreSyllablenotes)}%
			\ifdim\gre@temp@skip@two > -\wd\GreSyllablenotes %
				\kern\gre@temp@skip@two %
