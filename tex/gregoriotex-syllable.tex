...
\def\gre@compute@bolshift#1#2{%
  ...
  \gre@skip@temp@three=\gre@skip@spaceafterlineclef % TODO: or 0pt?
  ...
  \ifdim\gre@skip@temp@three < #1%
    \gre@skip@temp@three=\the #1%
  \fi %
  ...
  \ifnum#2=1%
    \ifdim\gre@dimen@initialwidth = 0pt %
      \ifnum\greknownline=1 %
        \advance\gre@skip@temp@three by \gre@dimen@clefwidth %
      \fi %
    \fi %
  \fi %
  \ifdim\gre@skip@temp@three > 0pt%
    \global\gre@dimen@bolshift=0pt%
  \else %
  ...
  \ifdim#1 <0pt%
    ...
    \ifnum\gredisableeolshifts=0\relax %
      \ifnum\greblockcusto=1\else %
        ...
        \global\advance\gre@skip@eolshift by -\wd\GreTempwidth %
