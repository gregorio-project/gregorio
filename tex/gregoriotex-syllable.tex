...
% if it is 0, it is the same as if it was unset
\attributedef\potentialdash=987
\fi
...
\ifluatex % by default, potentialdash will be 2
\potentialdash=2\relax %
\fi %
\firstglyph=1 %
...
\else %
\ifluatex %
\potentialdash=1\relax % in this particular case where it is not the end of a word and we haven't put a dash, we set potentital dash to 1
...
\kern -\begindifference %
\ifluatex % here we need to unset \potentialdash for the typesetting of notes
\potentialdash=0\relax %
\fi %
