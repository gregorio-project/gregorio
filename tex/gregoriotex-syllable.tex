...
\def\gre@compute@bolshift#1#2{%
  \global\gre@skip@bolshift=\gre@skip@spaceafterlineclef % TODO: or 0pt?
  \global\advance\gre@skip@bolshift by #1%
  ...
  \ifdim\gre@skip@bolshift <-\gre@dimen@clefwidth %
    \global\gre@skip@bolshift=-\gre@dimen@clefwidth %
  \fi %
  %% TODO: is following line really safe?
  \advance\gre@dimen@clefwidth by \gre@dimen@minimalspaceatlinebeginning %
  \global\advance\gre@skip@bolshift by -\gre@skip@spaceafterlineclef %
  \ifdim\gre@skip@bolshift < #1%
    \global\gre@skip@bolshift=\the #1%
  \fi %
  ...
  \ifnum#2=1%
    \ifdim\gre@dimen@initialwidth = 0pt %
      \ifnum\greknownline=1 %
        \global\advance\gre@skip@bolshift by \gre@dimen@clefwidth %
      \fi %
    \fi %
  \fi %
  \ifdim\gre@skip@bolshift > 0pt%
    \global\gre@skip@bolshift=0pt%
  \fi %
}
  ...
  \ifdim#1 <0pt%
    ...
    \ifnum\gredisableeolshifts=0\relax %
      \ifnum\greblockcusto=1\else %
        ...
        \global\advance\gre@eolshift by -\wd\GreTempwidth %
        \global\advance\gre@eolshift by -\gre@skip@spacebeforecusto %
      \fi %
      \global\advance\gre@eolshift by \gre@dimen@minimalspaceatlinebeginning %
    \fi %
    \ifdim\gre@eolshift <-#1 %
      \global\gre@eolshift=-#1%
    \fi %
  \fi %
}
