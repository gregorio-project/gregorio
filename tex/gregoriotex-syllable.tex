...
% #3: 1 if it is a vertical episemus, else 0
\def\calculateglyphraisevalue#1#2#3{%
\global\isonaline=\number 0%
\ifx a#1%
\global\tempcount=\number 1%
\fi%
...
\ifcase#3%
\global\isonaline=1 %
\or % if it is a vertical episemus, we don't care if it is on a line or not... which may cause some problems...
\fi %
\fi%
\ifx c#1%
\global\tempcount=\number 3%
...
%%%%% 9 : flexus deminutus
\def\glyph#1#2#3#4{%
\calculateglyphraisevalue{#2}{0}{0}%
