...
% The same but for the next syllable. DEPRECATED
...
\def\GreSyllable#1#2#3#4#5#6#7#8#9{%
  ...
  \gre@calculate@textaligncenter{\gre@firstsyllablepart}{\gre@middlesyllablepart}% we first get the width between the alignment point and the end of the syllable
...
\def\GreBarSyllable#1#2#3#4#5#6#7#8#9{%
  ...
  #1%
  \gre@calculate@textaligncenter{\gre@firstsyllablepart}{\gre@middlesyllablepart}%
