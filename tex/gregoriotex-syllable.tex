...
\def\GreBarSyllable#1#2#3#4#5#6#7#8#9{%
  ...
  \ifgre@newbarspacing%
    ...
    \global\let\gre@savedpenaltytype\gre@penalty %
    \global\let\gre@penalty\gre@falsepenalty %
    \xdef\gre@savedpenalty{0}%
    #9%
    \global\let\gre@penalty\gre@savedpenaltytype %
    \GreNoBreak%
    ...
    \ifx0\gre@savedpenalty %
      \gre@debugmsg{barspacing}{after bar penalty: \greendafterbarpenalty}%
      \gre@penalty{\greendafterbarpenalty}%
    \else %
      \gre@debugmsg{barspacing}{saved bar penalty: \gre@savedpenalty}%
      \gre@penalty{\gre@savedpenalty}%
    \fi %
  \else%
    %
