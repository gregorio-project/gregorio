...
\def\GreBarSyllable#1#2#3#4#5#6#7#8#9{%
  ...
  \ifgre@newbarspacing%
    ...
    \else%
      ...
      \ifdim\gre@dimen@previousenddifference > 0pt\relax%
        %we need to move back tow where the previous text ended
        \kern-\gre@dimen@previousenddifference\relax%
      \fi%
      \kern\gre@skip@temp@one\relax%
      \kern\gre@dimen@temp@one\relax%
      ...
      \kern\gre@dimen@temp@two\relax%
    \fi%		
    %finally we end by moving the cursor to be where it needs to be for the start of the next syllable and add the penalty
    \gre@debugmsg{spacing}{final cursor position after bar and penalty}%
    \ifdim\gre@skip@nextbegindifference < 0pt\relax%
