...
\def\GreSyllable#1#2#3#4#5#6#7#8#9{%
  ...
  \directlua{gregoriotex.save_syllable_info()}%
  ...
  \gre@attr@part=4 % text
  \ifcase#4
    \global\gre@possibleluahyphenafterthissyllabletrue
    \ifgre@showhyphenafterthissyllable
      \gre@attr@dash=5 % needs forced hyphen
    \else
      \gre@attr@dash=1 % maybe needs hyphen
    \fi
  \else
    ...
    \ifgre@showhyphenafterthissyllable
      \gre@attr@dash=5 % needs forced hyphen
    \else
      \gre@attr@dash=3 % end of word
    \fi
  \fi
  \setbox\gre@box@syllabletext=\hbox{\unhbox\gre@box@syllabletext}%
