...
\def\gresyllable#1#2#3#4#5#6#7#8#9{%
  ...
  \ifnum\grelastoflinecount=2\relax %
    \ifnum\gredisableeolshifts=0\relax%
      \gre@temp@skip@one=\gre@intersyllablespace %
      \advance\gre@temp@skip@one by \gre@begindifference %
      ...
      \ifdim\gre@temp@skip@one <-\gre@clefwidth %
        \gre@temp@skip@one=-\gre@clefwidth %
      \fi %
      \advance\gre@clefwidth by \gre@minimalspaceatlinebeginning %
      \hbox{}%
      \advance\gre@temp@skip@one by -\gre@spaceafterlineclef %
      \gre@debug{ifdim gre@temp@skip@one < gre@begindifference}%
      \ifdim\gre@temp@skip@one < \gre@begindifference %
        \gre@temp@skip@one=\the\gre@begindifference %
      \fi %
      ...
      \ifdim\gre@initialwidth = 0pt %
        \ifnum\greknownline=1 %
          \advance\gre@temp@skip@one by \gre@clefwidth %
        \fi %
      \fi %
      \gre@debug{ifdim temp@skip@one < 0pt}%
      \ifdim\gre@temp@skip@one < 0pt%
        \kern\gre@temp@skip@one %
      \fi %
  ...
  \else %\ifnum\grelastoflinecount=2
    ...
    \ifnum\grefirstsyllableofword=0 %
      ...
      \ifdim\gre@enddifference<0pt%
        \advance\gre@temp@skip@one by \gre@enddifference %
      \fi % \ifdim\gre@enddifference>0pt
      \ifnum\grefirstisalteration=1\relax %
        \advance\gre@temp@skip@one by \gre@beforealterationspace %
  ...
  \ifcase#4 %
    ...
    \gre@temp@skip@one=\gre@intersyllablespace %
    \advance\gre@temp@skip@one by \gre@nextbegindifference %
    \gre@debug{ifdim enddifference < 0pt}%
    \ifdim\gre@enddifference<0pt%
      \advance\gre@temp@skip@one by \gre@enddifference %
    \fi % \ifdim\gre@enddifference>0pt
    ...
    \ifdim\gre@temp@skip@one>\gre@maximumspacewithoutdash %
    ...
    \ifdim\gre@enddifference <0pt%
      ...
      \ifnum\gredisableeolshifts=0\relax %
        \ifnum\greblockcusto=1\else %
          ...
          \gre@temp@dimen@three=\wd\GreTempwidth %
          \advance\gre@temp@skip@one by -\gre@temp@dimen@three %
          \advance\gre@temp@skip@one by -\gre@spacebeforecusto %
        \fi %
        \advance\gre@temp@skip@one by \gre@minimalspaceatlinebeginning %
      \fi %
      \gre@debug{ifdim temp@skip@one < -enddifference}%
      \ifdim\gre@temp@skip@one <-\gre@enddifference %
        \gre@temp@skip@one=-\the\gre@enddifference %
      \fi %
      \xdef\grekernbeforeeol{\the\gre@temp@skip@one\relax}%
    \fi %
  \fi%
