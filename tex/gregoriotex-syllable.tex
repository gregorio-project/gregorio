...
\def\gresyllable#1#2#3#4#5#6#7#8#9{%
  ...
  \ifdim\the\gre@enddifference <0pt%
    ...
    \ifnum\grelastoflinecount=1\relax %
      \newskip\gre@temp
      \gre@temp = \grekernbeforeeol
      \kern\gre@temp %
    \else %
      \newskip\gre@temp
      \gre@temp = -\gre@enddifference
      \kern\gre@temp %
    \fi %
    \grenobreak %
  \fi%
