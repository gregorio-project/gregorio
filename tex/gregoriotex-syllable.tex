...
\def\gre@syllable@end#1#2#3{%
  ...
  \else %
    \ifnum\grelastoflinecount=1\relax %
      ...
      \or%
        \greendofsyllable{1}{0}{0}%
        \global\grefirstsyllableofword=1\relax %
      \fi%
    \else %\ifnum\grelastoflinecount=1
      \ifcase#3 %
        \greendofsyllable{0}{1}{0}%
        \global\grefirstsyllableofword=0\relax %
      \or%
        \greendofsyllable{1}{1}{0}%
        \global\grefirstsyllableofword=1\relax %
      \fi%
    \fi%
  \fi %
...
\def\greendofsyllable#1#2#3{%
  ...
  \ifnum#1=1\relax %
    ...
    \let\gre@curTextDistance\gre@skip@temp@three %
    \let\gre@curNotesDistance\gre@skip@temp@four %
%%  min_text_dist = prev_cur_word ? 0 : space_inter_words
    \ifnum#2=1\relax %
      \gre@minTextDistance=\gre@skip@intersyllablespace %
    \else %
