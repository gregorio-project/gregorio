...
\def\GreFirstSyllable#1{\gre@format@firstsyllable#1\endgre@format@firstsyllable}%
\def\GreFirstSyllableInitial#1{\gre@format@firstsyllableinitial#1\endgre@format@firstsyllableinitial}%
