...
% The NABC neumes are placed in zero-width boxes, so the space they need
% is provided by the syllable-spacing Lua filter, which enforces a minimum
% gap between the NABC of consecutive syllables.  This produces tighter
