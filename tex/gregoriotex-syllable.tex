...
\def\gre@syllablenotes#1{%
  ...
  \global\gre@firstglyphtrue%
  % now gre@lastendswithmora is true if this syllable ends with a punctum mora
...
\def\GreSyllable#1#2#3#4#5#6#7#8#9{%
  ...
  \gre@fixedtextformat{%
  \directlua{gregoriotex.save_syllable_info('note', #4)}%
  }%
...
%% @arg#2 1 if next syllable is a bar, 0 otherwise
%%
\def\gre@endofsyllable#1#2{%
  \gre@trace{gre@endofsyllable{#1}{#2}}%
...
\def\GreBarSyllable#1#2#3#4#5#6#7#8#9{%
  ...
  \gre@beginningofscorefalse
  \gre@fixedtextformat{%
  \directlua{gregoriotex.save_syllable_info('bar', #4)}%
  }%
  \gre@possibleluahyphenafterthissyllablefalse %
  \gre@showhyphenafterthissyllablefalse %
