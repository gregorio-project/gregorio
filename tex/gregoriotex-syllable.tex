...
% if wd(#1/2) > \gretextaligncenter then #2
% else
%   if \gre@englishcentering = 0:
%       if wd(\gre@endsyllablepart) > \gre@clivisalignmentmin -> #2 else #1
%   else:
%      if (\gretextaligncenter) > \gre@clivisalignmentmin -> #2 else #1
%
...
\def\grehandleclivisspecialalignment#1#2#3{
  ...
  \or%
    ...
    \ifdim\gretempwidth >\gretextaligncenter %
      \global\setbox\GreTempwidth=\hbox{#2}%
    \else%
      \ifcase\gre@englishcentering%
        \grewidthof{\mygre@endsyllablepart}%
        \ifdim\gretempwidth >\gre@clivisalignmentmin %
          \global\setbox\GreTempwidth=\hbox{#2}%
        \else%
          \global\setbox\GreTempwidth=\hbox{#1}%
        \fi%
      \or%
        \ifdim\gretextaligncenter >\gre@clivisalignmentmin %
          \global\setbox\GreTempwidth=\hbox{#2}%
        \else%
          \global\setbox\GreTempwidth=\hbox{#1}%
        \fi%
...
\setlength{\gre@clivisalignmentmin}{1mm}

\def\clivisalignmentalways{
  \global\gre@clivisalignment=0
}

\def\clivisalignmentnever{
  \global\gre@clivisalignment=1
}

\def\clivisalignmentspecial{
  \global\gre@clivisalignment=2
}
...
\def\gresyllable#1#2#3#4#5#6#7#8#9{%
  ...
  #5%
  \gresetnextbegindifference{\gre@nextfirstsyllablepart}{\gre@nextmiddlesyllablepart}{\gre@nextendsyllablepart}{#7}%
...
\def\grebarsyllable#1#2#3#4#5#6#7#8#9{%
  ...
  \gresetenddifference{\wd\GreSyllablenotes}{\wd\GreSyllabletext}{\gretextaligncenter}{\grenotesaligncenter}{1}%
  #5%
  \gresetnextbegindifference{\gre@nextfirstsyllablepart}{\gre@nextmiddlesyllablepart}{\gre@endsyllablepart}{#7}%
  \greunsetfixednexttextformat %
