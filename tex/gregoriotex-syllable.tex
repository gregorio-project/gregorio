...
%    \hbox to 0pt{a\hss}%
    \ifdim\gre@minShiftNotes < \gre@minShiftText %
      \hskip\gre@minShiftText %
      \gre@debugmsg{syllablespacing}{ hskip \the\gre@minShiftText}%
    \else %
      \hskip\gre@minShiftNotes %
      \gre@debugmsg{syllablespacing}{ hskip \the\gre@minShiftNotes}%
    \fi %
%    \hbox to 0pt{b\hss}%
  \fi %
  \relax%
