...
\def\GreGlyph#1#2#3#4#5#6#7{%
  \gre@newglyphcommon %
  \setbox\gre@box@temp@width=\hbox{\gre@pointandclick{\gre@font@neumebase #1}{#7}}%
...
\def\gre@calculate@simplenotesaligncenter#1#2{%
  \ifcase#1%
    %case of punctum
    \global\setbox\gre@box@temp@width=\hbox{\gre@font@neumebase\GreCPPunctum}%
  \or%
    %case of flexus
    \gre@handleclivisspecialalignment{\gre@font@neumebase\GreCPPesQuadratumLongqueueThreeNothing}{\gre@font@neumebase\GreCPPunctum}{#2}%
  \or%
    %case of porrectus (we consider it to have the same alignment as punctum)
    \global\setbox\gre@box@temp@width=\hbox{\gre@font@neumebase\GreCPPunctum}%
  \or%
    %case of a initio debilis
    \global\setbox\gre@box@temp@width=\hbox{\gre@font@neumebase\GreCPPunctumDeminutus}%
  \or %
    %case of a quilisma
    \global\setbox\gre@box@temp@width=\hbox{\gre@font@neumebase\GreCPQuilisma}%
  \or %
    %case of an oriscus
    \global\setbox\gre@box@temp@width=\hbox{\gre@font@neumebase\GreCPOriscus}%
  \or %
    %case of a punctum inclinatum
    \global\setbox\gre@box@temp@width=\hbox{\gre@font@neumebase\GreCPPunctumInclinatum}%
  \or %
    %case of a stropha
    \global\setbox\gre@box@temp@width=\hbox{\gre@font@neumebase\GreCPStropha}%
  \or %
    % case of flexus with ambitus of one
    \gre@handleclivisspecialalignment{\gre@font@neumebase\GreCPPesQuadratumLongqueueOneNothing}{\gre@font@neumebase\GreCPPunctum}{#2}%
  \or %
    % case of flexus deminutus
    \gre@handleclivisspecialalignment{\gre@font@neumebase\GreCPFlexusTwoDeminutus}{\gre@font@neumebase\GreCPPunctum}{#2}%
  \or %
    % case of virgula
    \global\setbox\gre@box@temp@width=\hbox{\gre@font@neumebase\GreCPVirgula}%
  \or %
...
\def\gre@endofsyllable#1#2#3{%
  ...
  \fi %
  \ifnum#1=1\relax %
    \gre@hskip\gre@skip@syllablefinalskip %
    \ifnum#3=1\relax %
      \GreNoBreak %
    \fi %
  \fi %
