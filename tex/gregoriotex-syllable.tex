...
\def\greglyph#1#2#3#4#5#6{%
  ...
  \gre@temp@dimen@three=\wd\GreTempwidth %
  \global\gre@lastglyphwidth=\gre@temp@dimen@three %
  ...
  \fi%
  %\gre@lastglyphwidth=\gre@temp@dimen@three
  %#5\relax 
  #6\relax %
  \relax%
}%
...
\def\grefindnotesaligncenter#1{%
  ...
  \gre@temp@dimen@five=\wd\GreTempwidth %
  \divide\gre@temp@dimen@five by 2\relax %
  \global\advance\gre@notesaligncenter by \gre@temp@dimen@five %
  \relax %
}%
...
\def\grefindnextnotesaligncenter#1{%
  \ifnum#1<20\relax %
    ...
    \gre@temp@dimen@five=\wd\GreTempwidth %
    \divide\gre@temp@dimen@five by 2\relax %
    \global\gre@notesaligncenter=\gre@temp@dimen@five %
  \else %\ifnum#1<20
    \gre@temp@count@three=#1 %
    \ifnum#1<40\relax%
      \advance\gre@temp@count@three by -20\relax %
      \grefindsimplenotesaligncenter{\gre@temp@count@three}{1}%
      \gre@temp@dimen@five=\wd\GreTempwidth %
      \divide\gre@temp@dimen@five by 2\relax %
      \setbox\GreTempwidth=\hbox{\gregoriofont \char 6}%
    \else%\ifnum#1<40
      \advance\gre@temp@count@three by -40\relax %
      \grefindsimplenotesaligncenter{\gre@temp@count@three}{1}%
      \gre@temp@dimen@five=\wd\GreTempwidth %
      \divide\gre@temp@dimen@five by 2\relax %
      \setbox\GreTempwidth=\hbox{\gregoriofont \char 7}%
    \fi %
    \advance\gre@temp@dimen@five by \wd\GreTempwidth %
    \global\gre@notesaligncenter=\gre@temp@dimen@five %
  \fi %
  \relax %
}%
...
\def\gresyllable#1#2#3#4#5#6#7#8#9{%
  ...
  \ifnum\grelastoflinecount=2\relax %
    \ifnum\gredisableeolshifts=0\relax%
      \gre@temp@dimen@five=\gre@intersyllablespace %
      \advance\gre@temp@dimen@five by \gre@begindifference %
      ...
      \ifdim\gre@temp@dimen@five <-\gre@clefwidth %
        \gre@temp@dimen@five=-\gre@clefwidth %
      \fi %
      \advance\gre@clefwidth by \gre@minimalspaceatlinebeginning %
      \hbox{}%
      \advance\gre@temp@dimen@five by -\gre@spaceafterlineclef %
      \gre@debug{ifdim gre@temp@dimen@five < gre@begindifference}%
      \ifdim\gre@temp@dimen@five < \gre@begindifference %
        \gre@temp@dimen@five=\the\gre@begindifference %
      \fi %
      ...
      \ifdim\gre@initialwidth = 0pt %
        \ifnum\greknownline=1 %
          \advance\gre@temp@dimen@five by \gre@clefwidth %
        \fi %
      \fi %
      \gre@debug{ifdim tempdim < 0pt}%
      \ifdim\gre@temp@dimen@five < 0pt%
        \kern\gre@temp@dimen@five %
      \fi %
  ...
  \ifcase#4 %
    ...
    \gre@temp@dimen@five=\gre@intersyllablespace %
    \advance\gre@temp@dimen@five by \gre@nextbegindifference %
    \gre@debug{ifdim enddifference < 0pt}%
    \ifdim\gre@enddifference<0pt%
      \advance\gre@temp@dimen@five by \gre@enddifference %
    \fi % \ifdim\gre@enddifference>0pt
    ...
    \ifdim\gre@temp@dimen@five>\gre@maximumspacewithoutdash %
  ...
  \ifnum\grelastoflinecount=1\relax %
    \gre@debug{ifdim enddifference < 0pt}%
    \ifdim\gre@enddifference <0pt%
      \gre@temp@dimen@five=-\gre@enddifference %
      ...
      \ifnum\gredisableeolshifts=0\relax %
        \ifnum\greblockcusto=1\else %
          ...
          \gre@temp@dimen@three=\wd\GreTempwidth %
          \advance\gre@temp@dimen@five by -\gre@temp@dimen@three %
          \advance\gre@temp@dimen@five by -\gre@spacebeforecusto %
        \fi %
        \advance\gre@temp@dimen@five by \gre@minimalspaceatlinebeginning %
      \fi %
      \gre@debug{ifdim tempdim < -enddifference}%
      \ifdim\gre@temp@dimen@five <-\gre@enddifference %
        \gre@temp@dimen@five=-\the\gre@enddifference %
      \fi %
      \xdef\grekernbeforeeol{\the\gre@temp@dimen@five\relax}%
    \fi %
  \fi%
...
\def\grebarsyllable#1#2#3#4#5#6#7#8#9{%
  ...
  \ifdim\wd\GreSyllabletext = 0 pt\relax %
    ...
    \gre@temp@skip@three=\gre@notebarspace %
    \advance\gre@temp@skip@three by \gre@notebarspace %
    \advance\gre@temp@skip@three by \wd\GreSyllablenotes %
    % now let's get temp
    \gre@debug{ifdim nextbegindifference < 0pt}%
    \ifdim\gre@nextbegindifference < 0 pt%
      \gre@temp@dimen@five=-\gre@nextbegindifference %
    \else %
      \gre@temp@dimen@five=0 pt%
    \fi %
    \gre@debug{ifdim previousenddifference < 0pt}%
    \ifdim\gre@previousenddifference < 0 pt%
      \advance\gre@temp@dimen@five by -\gre@previousenddifference %
      \advance\gre@temp@dimen@five by \gre@interwordspacetext % in fact it is the max between interwordspacetext and interwordspacetextnotes
    \else %
      \advance\gre@temp@dimen@five by \gre@interwordspacenotestext % in fact it is the max between interwordspacenotestext and interwordspacenotes
    \fi%
    ...
    \ifdim\gre@temp@skip@three <\gre@temp@dimen@five %
      \gre@temp@skip@three=\gre@temp@dimen@five %
    \fi %
    \divide\gre@temp@skip@three by 2\relax %
    \gre@temp@dimen@five=\wd\GreSyllablenotes %
    \divide\gre@temp@dimen@five by 2\relax %
    \advance\gre@temp@skip@three by -\gre@temp@dimen@five %
    % now we have our skipone
    \gre@temp@dimen@five=\gre@temp@skip@three %
    \gre@debug{ifdim previousenddifference < 0pt}%
    \ifdim\gre@previousenddifference < 0 pt%
      \advance\gre@temp@dimen@five by \gre@previousenddifference %
    \fi %
    ...
    \ifdim\gre@temp@dimen@five > -\wd\GreSyllablenotes %
      \kern\gre@temp@dimen@five %
    \else %
    ...
    \ifdim\gre@temp@dimen@five < -\wd\GreSyllablenotes %
      ...
      \else % \ifdim\gre@nextbegindifference > 0 pt
        ...
        \hskip\gre@temp@skip@one %
      \fi %
    \else % \ifdim\gre@temp@dimen@five < -\wd\GreSyllablenotes
      %\gre@temp@dimen@five=\wd\GreSyllablenotes 
      %\divide\gre@temp@dimen@five by 2\relax 
      %\kern -\gre@temp@dimen@five 
      \gre@temp@dimen@five=\gre@temp@skip@three %
  ...
  \else %ifdim\wd\GreSyllabletext = 0 pt 
    ...
    \gre@temp@skip@three=\gre@textbartextspace %
    % same code as in syllable
    \gre@temp@dimen@five=\gre@begindifference %
    \gre@debug{ifdim tempdim > 0pt}%
    \ifdim\gre@temp@dimen@five > 0 pt%
      \advance\gre@temp@skip@three by \gre@temp@dimen@five %
    \fi%
    %\kern\gre@temp@skip@three 
    #8\relax %
    \raise\gre@textlower \copy\GreSyllabletext %
    \ifnum\gremustdotranslationcenterend=1\relax %
      % case of end of translation centering, we do it after the typesetting of the text
...
%\gre@temp@dimen@five=\gre@previousenddifference 
%\advance\gre@temp@dimen@five by \intersyllablenotesspace 
%\ifdim#1 >\gre@temp@dimen@five 
%\kern #1 
%test3
%\else
%\kern\gre@temp@dimen@five
