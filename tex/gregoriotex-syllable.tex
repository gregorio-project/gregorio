...
\def\gre@compute@bolshift#1#2{%
  \global\gre@bolshift=\gre@spaceafterlineclef % TODO: or 0pt?
  \global\advance\gre@bolshift by #1%
  ...
  \ifdim\gre@bolshift <-\gre@clefwidth %
    \global\gre@bolshift=-\gre@clefwidth %
  \fi %
  \advance\gre@clefwidth by \gre@minimalspaceatlinebeginning %
  \global\advance\gre@bolshift by -\gre@spaceafterlineclef %
  \ifdim\gre@bolshift < #1%
    \global\gre@bolshift=\the #1%
  \fi %
  % Don't allow kern past the beginning of the first line with no initial
  \ifnum#2=1%
    \ifdim\gre@initialwidth = 0pt %
      \ifnum\greknownline=1 %
        \global\advance\gre@bolshift by \gre@clefwidth %
      \fi %
    \fi %
  \fi %
  \ifdim\gre@bolshift > 0pt%
    \global\gre@bolshift=0pt%
  \fi %
}
...
\def\gresyllable#1#2#3#4#5#6#7#8#9{%
  ...
  \ifnum\grelastoflinecount=2\relax %
    \ifnum\gredisableeolshifts=0\relax%
      \gre@compute@bolshift{\gre@begindifference}{1}%
      \showthe\gre@bolshift %
      \kern\gre@bolshift %
    \fi %
