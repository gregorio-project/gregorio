...
\let\gre@save@fixedtextformat\gre@ignore\relax %
...
\def\gre@emit@savedendsyllablepart{%
  \ifx\gre@save@endsyllablepart\gre@nothing\else %
...
\def\GreSyllable#1#2#3#4#5#6#7#8#9{%
  ...
  \gre@calculate@textaligncenter{\gre@save@fixedtextformat{\gre@save@endsyllablepart}\gre@fixedtextformat{\gre@firstsyllablepart}}{\gre@fixedtextformat{\gre@middlesyllablepart}}{0}% we first get the width between the alignment point and the end of the syllable
  ...
  \ifgre@showlyrics%
    \setbox\gre@box@syllabletext=\hbox{\gre@emit@savedendsyllablepart\gre@fixedtextformat{\gre@pointandclick{\gre@firstsyllablepart\gre@middlesyllablepart\gre@emit@endsyllablepart}{#6}}}%
  \else%
  ...
  \ifgre@showhyphenafterthissyllable\relax%
    ...
    \ifnum\gre@lastoflinecount=1\relax %
      \ifgre@showlyrics%
        \setbox\gre@box@syllabletext=\hbox{\gre@emit@savedendsyllablepart\gre@fixedtextformat{\gre@pointandclick{\gre@firstsyllablepart\gre@middlesyllablepart\gre@emit@endsyllablepart#3{\GreHyph}\relax}{#6}}}%
      \else%
        \setbox\gre@box@syllabletext=\box\voidb@x%
      \fi%
    \else %
      \ifgre@showlyrics%
        \setbox\gre@box@syllabletext=\hbox{\gre@emit@savedendsyllablepart\gre@fixedtextformat{\gre@pointandclick{\gre@firstsyllablepart\gre@middlesyllablepart\gre@emit@endsyllablepart#3{-}}{#6}}}%
      \else%
        \setbox\gre@box@syllabletext=\box\voidb@x%
      \fi%
    \fi %
...
\def\GreBarSyllable#1#2#3#4#5#6#7#8#9{%
  ...
  #1%
  \gre@calculate@textaligncenter{\gre@save@fixedtextformat{\gre@save@endsyllablepart}\gre@fixedtextformat{\gre@firstsyllablepart}}{\gre@fixedtextformat{\gre@middlesyllablepart}}{0}%
  \ifgre@showlyrics%
    \setbox\gre@box@syllabletext=\hbox{\gre@emit@savedendsyllablepart\gre@fixedtextformat{\gre@pointandclick{\gre@firstsyllablepart\gre@middlesyllablepart\gre@emit@endsyllablepart}{#6}}}%
  \else%
    \setbox\gre@box@syllabletext=\box\voidb@x%
