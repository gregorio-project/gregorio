...
\def\GreSyllable#1#2#3#4#5#6#7#8#9{%
  ...
  \gre@dimen@enddifference@textwidth=\dimexpr\wd\gre@box@syllabletext+\gre@dimen@extrarightoverhang\relax%
  \gre@calculate@enddifference{\wd\gre@box@syllablenotes}{\gre@dimen@enddifference@textwidth}{\gre@dimen@textaligncenter}{\gre@dimen@notesaligncenter}{1}%
