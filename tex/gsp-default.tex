...
% redundant code in gregoriotex-spaces.tex had 80 here instead of 78.  Since the code loading order means that this was the ruling code, I've simply removed the redundant code over in gregoriotex-spaces.tex without making any changes here.
...
% space before custo
\grecreatedim{spacebeforecusto}{0.1823 cm plus 0.31903 cm minus 0.0638 cm}{1}%
