...
\grecreatedim{interwordspacetext@bars}{0.15 cm plus 0.22787cm minus 0.02 cm}{scalable}%
% minimal space between letters of different syllable texts for text around bars,
% euouae context
\grecreatedim{interwordspacetext@bars@euouae}{0.15 cm plus 0.22787cm minus 0.02 cm}{scalable}%
...
% A bit complex: when realigning text and bar in case the offset is superior to
% maxbaroffsettextleft or maxbaroffsettextright, we add space around bar to
% keep it centered, but no more than baroffsetadditionalspacearoundbars
\grecreatedim{baroffsetadditionalspacearoundbars}{0.1 cm}{scalable}%
