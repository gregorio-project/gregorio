...
% minimum gap between the NABC neumes of consecutive syllables; enforced by
% the syllable-spacing Lua filter when NABC extends past the notes of its
% syllable.  Default: 25% of intersyllablespacenotes.
