/*
 * Gregorio unicode headers. Copyright (C) 2008 Elie Roux
 ...
 * 
 * This file is used only for the ALL_STATIC option, it contains the
 * definitions of the functions called to read or write scores for the
 * different plugins. 
 */
