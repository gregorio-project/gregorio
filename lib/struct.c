...
gregorio_add_syllable (gregorio_syllable ** current_syllable,
			  ...
			  gregorio_character * first_character, gregorio_character *first_translation_character, char position, char *abovelinestext, unsigned char translation_type, unsigned char no_linebreak_area, unsigned char euouae)
{
