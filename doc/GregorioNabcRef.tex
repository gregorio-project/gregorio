...
\textit{Cf.} \sneume{ta>} & \texttt{ta>}\\ \hline
...
\sneume{vi-su2sut1} & \texttt{vi-su2sut1} & \texttt{N296V} & alleluia\\ \hline
...
\sneume{sa>2} & \texttt{sa>2} & \texttt{H73S} & viderunt\\ \hline
...
\sneume{su2suy1} & \texttt{su2suy1} \textit{Cf.} \sneume{pe-su2suy1} & \multicolumn{2}{l}{\texttt{pe-su2suy1}}\\ \hline
\\
...
\sneume{pf!clMppt1} & \texttt{pf!clMppt1} & \texttt{E327O} & narante & \fbox{2.166x}\\
...
\sneume{pf!clM} & \texttt{pf!clM} \textit{Cf.} \sneume{pf!clMppt1} & \multicolumn{3}{l}{\texttt{pf!clMppt1} minus tractulus}\\
