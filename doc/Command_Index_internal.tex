...
\verb=\gre@dimen@boxedscorewidth= unless \verb=\ifgre@boxedscorewidth@auto=
is true, in which case the ambient \verb=\hsize= is kept) inside a
...
Boolean used to indicate whether \verb=\boxedgregorioscore= should use the
ambient \verb=\hsize= (true, the default) or the width set by
