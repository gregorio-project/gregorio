...
\macroname{\textbackslash gre@calculate@textaligncenter}{\#1\#2}{gregoriotex-spaces.tex}
...
\macroname{\textbackslash gre@calculate@enddifference}{\#1\#2\#3\#4}{gregoriotex-spaces.tex}
...
\macroname{\textbackslash gre@endofsyllable}{\#1\}{gregoriotex-syllable.tex}
...
\macroname{\textbackslash gre@calculate@simplenotesaligncenter}{\#1}{gregoriotex-syllable.tex}
Workhorse function behind \verb=\gre@calculate@notesaligncenter=.
...
\macroname{\textbackslash gre@handleclivisspecialalignment}{\#1\#2}{gregoriotex-syllable.tex}
