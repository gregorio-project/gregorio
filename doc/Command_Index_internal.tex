...
\macroname{\textbackslash gre@def@char@he@prr}{\#1\#2}{gregoriotex-chars.tex}
...
\macroname{\textbackslash gre@nabcfont}{}{gregoriotex-nabc.tex}
Macro to apply the font for the \texttt{nabc} notation.
...
\macroname{\textbackslash gre@ptich@adjust@top}{}{gregoriotex-main.tex}
...
Macro which indicates whether the point-and-click functionality should be implemented (1) or not (0).  Not a boolean because it needs to be readable by Lua.
...
Creates a line break in warning and error messages.  Copied from \LaTeX\ source.

\macroname{\textbackslash protect}{}{gregoriotex.tex}
Prints the name of the macro, rather than its contents in warning and error messages.  Copied from \LaTeX\ source.

\macroname{\textbackslash protected@edef}{}{gregoriotex.tex}
Version of \verb=\edef= which protects the expansion of fragile macros which could not otherwise appear in an \verb=\edef= statement.  Copied from the \LaTeX\ source.

\macroname{\textbackslash @unexpandable@protect}{}{gregoriotex.tex}
Macro used in defining \verb=\protected@edef=.  Copied from the \LaTeX\ source.

\macroname{\textbackslash restore@protect}{}{gregoriotex.tex}
Macro used in defining \verb=\protected@edef=.  Copied from the \LaTeX\ source.

\macroname{\textbackslash @edef}{}{gregoriotex.tex}
Macro used in defining \verb=\protected@edef=.  Copied from the \LaTeX\ source.
