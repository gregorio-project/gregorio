...
These additional distances are calculated by Gregorio based on the values for the user thizable distances and what may be going on in the score at the time of their use.
