...
\macroname{\textbackslash ger@typekey}{\#1\#2\#3\#4\#5}{gregoriotex-signs.tex}
...
\macroname{\textbackslash gre@temp@dimen@**}{}{gregoriotex-spaces.tex}
Temporary dimensions used in calculations.  There are currently five of these.

\macroname{\textbackslash gre@temp@skip@**}{}{gregoriotex-spaces.tex}
