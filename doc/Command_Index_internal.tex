...
\macroname{\textbackslash gre@custo}{\#1}{gregoriotex-signs.tex}
...
\macroname{\textbackslash gre@char@abovebarbrace}{}{gregoriotex-chars.tex}
The above bar brace.

\macroname{\textbackslash gre@char@flat}{}{gregoriotex-chars.tex}
The flat character.

\macroname{\textbackslash gre@char@flathole}{}{gregoriotex-chars.tex}
The flat hole character (\ie, the character needed to prevent lines from showing through the center of the flat).

\macroname{\textbackslash gre@char@natural}{}{gregoriotex-chars.tex}
The natural character.

\macroname{\textbackslash gre@char@naturalhole}{}{gregoriotex-chars.tex}
The natural hole character (\ie, the character needed to prevent lines from showing through the center of the natural).

\macroname{\textbackslash gre@char@sharp}{}{gregoriotex-chars.tex}
The sharp character.

\macroname{\textbackslash gre@char@sharphole}{}{gregoriotex-chars.tex}
The sharp hole character (\ie, the character needed to prevent lines from showing through the center of the sharp).

\macroname{\textbackslash gre@char@punctumcavum}{}{gregoriotex-signs.tex}
The punctum cavum character.

\macroname{\textbackslash gre@char@punctumcavumhole}{}{gregoriotex-signs.tex}
...
\macroname{\textbackslash gre@char@incclef}{}{gregoriotex-chars.tex}
The \texttt{c}-clef which appears in the middle of a line.

\macroname{\textbackslash gre@char@infclef}{}{gregoriotex-chars.tex}
The \texttt{f}-clef which appears in the middle of a line.

\macroname{\textbackslash gre@char@cclef}{}{gregoriotex-chars.tex}
The \texttt{c}-clef which appears at the beginning of a line.

\macroname{\textbackslash gre@char@fclef}{}{gregoriotex-chars.tex}
The \texttt{f}-clef which appears at the beginning of a line.

\macroname{\textbackslash gre@char@punctum}{}{gregoriotex-chars.tex}
The punctum character.

\macroname{\textbackslash gre@char@punctummora}{}{gregoriotex-chars.tex}
The punctum mora character.

\macroname{\textbackslash gre@char@underbrace}{}{gregoriotex-signs.tex}
The under brace character.

\macroname{\textbackslash gre@char@verticalepisemus}{}{gregoriotex-chars.tex}
The vertical episemus character.

\macroname{\textbackslash gre@char@brace}{}{gregoriotex-signs.tex}
The (rounded) brace character.

\macroname{\textbackslash gre@char@curlybrace}{}{gregoriotex-signs.tex}
The curly brace character.

\macroname{\textbackslash gre@char@custobottomlong}{}{gregoriotex-chars.tex}
The custo character with a long upwards directed vigra.

\macroname{\textbackslash gre@char@custobottommiddle}{}{gregoriotex-chars.tex}
The custo character with a middle upwards directed vigra.

\macroname{\textbackslash gre@char@custobottomshort}{}{gregoriotex-chars.tex}
The custo character with a short upwards directed vigra.

\macroname{\textbackslash gre@char@custotoplong}{}{gregoriotex-chars.tex}
The custo character with a long downwards directed vigra.

\macroname{\textbackslash gre@char@custotopmiddle}{}{gregoriotex-chars.tex}
The custo character with a middle downwards directed vigra.

\macroname{\textbackslash gre@char@custotopshort}{}{gregoriotex-chars.tex}
The custo character with a short downwards directed vigra.

\macroname{\textbackslash gre@char@divisiofinalis}{}{gregoriotex-signs.tex}
The divisio finalis.

\macroname{\textbackslash gre@char@divisiomaior}{}{gregoriotex-signs.tex}
The divisio maior.
...
\macroname{\textbackslash gre@boxing}{}{gregoriotex-syllable.tex}
