...
Macro called at the beginning of a set of gabc headers.  This macro should be redefined as necessary should something to be done at the beginning of the headers.

\macroname{\textbackslash GreEndHeaders}{}{gregoriotex-main.tex}
Macro called at the end of a set of gabc headers.  This macro should be redefined as necessary should something need to be done at the end of the headers.
