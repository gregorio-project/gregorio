...
\begin{argtable}
  ...
  \#2 & string  & Type of glyph the musica ficta flat is attached to. See \nameref{EpisemaSpecial} argument for description of options.\\
\end{argtable}
...
\begin{argtable}
  ...
  \#2 & string  & Type of glyph the musica ficta natural is attached to. See \nameref{EpisemaSpecial} argument for description of options.\\
\end{argtable}
...
\begin{argtable}
  ...
  \#2 & string  & Type of glyph the musica ficta sharp is attached to. See \nameref{EpisemaSpecial} argument for description of options.\\
\end{argtable}
