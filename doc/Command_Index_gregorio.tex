...
Macro to mark that this syllable is the last of the line). Deprecated.
...
Indicates that this syllable is the last syllable before a EUOUAE block. Deprecated
...
Same as \verb=\GreSetFixedTextFormat= except for next syllable. Deprecated.
...
Macro to set the text of the next syllable for spacing purposes. Deprecated.
...
Macro inserted into \verb=\GreSyllable= and \verb=\GreBarSyllable= to indicate that the center of the of the next syllable was forced in the gabc with curly braces (``\{'' and ``\}''). Deprecated.
