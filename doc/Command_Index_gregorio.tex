...
\macroname{\textbackslash GreAnnotationLine}{\#1}{gregoriotex-main.tex}
A wrapper macro for placing annotations above the initial. The
argument is provided by the \texttt{gabc} file in the
...
\begin{argtable}
  \#1 & string & Text to place above the initial.\\
\end{argtable}
