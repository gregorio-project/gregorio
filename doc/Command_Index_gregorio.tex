...
\macroname{\textbackslash GreSetInitialStyle}{\#1}{gregoriotex-syllable.tex}
Sets the style of initial.

\begin{argtable}
  \#1 & 0 & Score has no initial.\\
      & 1 & Score has a normal initial.\\
      & 2 & Score has a big initial.\\
\end{argtable}
