...
\begin{titlepage}
  \begin{center}
    ...
    \large Version \textbf{4.0.0-rc1}, 26 April 2015 %% PARSE_VERSION_DATE
    ...
    \begingroup%
      ...
      \gresetfirstannotation{\scriptsize{Comm.}}
      \gresetsecondannotation{\scriptsize{VII}}
      \color{black!60}
      ...
      }\item[]{\fbox{\parbox{\hsize}{\includescore{factus.gtex}}}}%
      \end{list}%
    \endgroup%
