...
Flats, sharps, and naturals each have a ``soft'' version (\verb|X|, \verb|#*|, and \verb|Y|, respectively), whose appearance is controlled by the \verb|\gresetalterationeffect| macro (see \S\ref{setalterationeffect}). For Dominican chant, use \verb|\gresetalterationeffect{line}| and make all alterations soft.
