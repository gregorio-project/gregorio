...
The length of the stem is deterministically determined for most neumes.
Some manual input might be needed though, for notes on the bottom staff
...
To solve this problem, you can add \texttt{[ll:0]} to a note to force its
short form, or \texttt{[ll:1]} to force its long form:
...
% LuaTeX segfaults when appending dcd<v>[</v>ll:0<v>]</v>!b(dcd[ll:0]!b)
% to previous example!
