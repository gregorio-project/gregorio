...
Substitutes the given GregorioTeX glyph with the specified glyph from
the specified font.
...
Removes a GregorioTeX glyph substitution, restoring it back to its
original form.
...
glyph substitution.  This is a lower-level macro whose purpose is to
redefine GregorioTeX control sequences with variant glyphs.
