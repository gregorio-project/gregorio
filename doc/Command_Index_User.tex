...
\macroname{\textbackslash grechangeglyph\{\#1\}\{\#2\}\{\#3\}}{gregoriotex.tex}
...
\macroname{\textbackslash greresetglyph\{\#1\}}{gregoriotex.tex}
...
\subsection[Barred letters (A/, etc.)]{Barred letters (\ABar, etc.)}
...
\begin{latexcode}
  \gresimpledefbarglyph{A}{-0.375em}
\end{latexcode}

Will define \texttt{\textbackslash ABar} to be a A with the bar shifted left
of \texttt{-0.375em} from the end of the glyph. This is the default definition
...
\begin{argtable}
  ...
  \#5 & dimension & horizontal shift of the bar glyph.\\
...
\begin{footnotesize}
\begin{latexcode}
  \greexpldefbarglyph{RBarBold}{\textbf{R}}{greRBarSmall}{13}{-0.225em}{0.05em}
\end{latexcode}
\end{footnotesize}
...
, at 12pt, shifted left of \texttt{-0.375 em} from the end of the glyph, and lowered down
by \texttt{0.1em}. The result is: \RBarBold .
