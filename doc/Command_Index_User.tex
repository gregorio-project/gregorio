...
Gregorio will call \verb=\GreBeginHeaders= before processing a given set of
headers and \verb=\GreEndHeaders= after processing them.  By default, these
macros do not do anything.  However, they may be redefined as needed to
hook onto these events.
