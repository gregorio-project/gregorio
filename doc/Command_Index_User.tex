...
syllables in polysyllabic words.  This is done by overriding \texttt{maximumspacewithoutdash} so subsequent changes to this dimension will override this command.

Note: This command only affects the hyphens within a score.  Hyphens
elsewhere in a document are unaffected.

\macroname{\textbackslash greautohyphen}{}{gregoriotex.tex}
Tell Gregorio\TeX\ to determine the appearance of hyphens between
syllables in polysyllabic words based on spacing.  This is done by setting \texttt{maximumspacewithoutdash} back to the value found in \texttt{gsp-default.tex}.
