...
\begin{argtable}
  \#1 & \texttt{firsttop} & The initial letter's anchor is aligned with the top of the first line. \\
  & \texttt{firstbaseline} & The initial letter's anchor is aligned with the baseline of the first line. \\
  & \texttt{lastbaseline} & The initial letter's anchor is aligned with the baseline of the last line next to the initial (default). \\
