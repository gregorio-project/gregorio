...
\end{argtable}
Setting \verb|\gresetalterationeffect{note}| causes all soft sharps and flats, and no soft naturals, to be printed.
Setting \verb|\gresetalterationeffect{line}|, and making all alterations soft, gives the Dominican convention.

(Argument \#1 is actually a comma-separated list of keywords, but currently, it must not be empty, and \texttt{note,line} has the same effect as \texttt{note}. In the future, other options may be added.)
