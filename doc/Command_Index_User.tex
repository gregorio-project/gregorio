...
\begin{argtable}
  \#1 & force & all later calls of \verb=\gregorioscore= will compile the gabc
file into a gtex file.\\
  & auto & all later calls of \verb=\gregorioscore= will use Gregorio\TeX's
automatic compilation of gabc files.\\
  & never & all later calls of \verb=\gregorioscore= will include the score
