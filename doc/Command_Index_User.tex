...
\macroname{\textbackslash greseperator}{\{\#1\}\{\#2\}}{gregoriotex-symbols.tex}
...
\begin{tabular}{lp{7cm plus .5cm}r}
  ...
  \texttt{translation} & Translation text (appears below lyrics) & {\it italics}\\
  ...
  \texttt{additionalstafflines} & short lines behind notes above or below the staff & special\footnotemark[1]\\
  ...
  \texttt{modeline} & the rendered annotation from the \texttt{mode: ;} header in the gabc file & \parbox[t]{2.2cm}{\raggedleft\textsc{\textbf{Bold Small Capitals}}}\\
  \texttt{nabc} & ancient notation & {\color{gregoriocolor}gregoriocolor} (\LaTeX)\\
  && none (Plain\TeX)\\
\end{tabular}
...
\macroname{\textbackslash nabcinterelementspace}{}{gsp-default.tex}
Space between elements in ancient notation.

Default: \unit[0.06927]{cm} plus \unit[0.00182]{cm} minus \unit[0.00363]{cm}

\macroname{\textbackslash nabclargerspace}{}{gsp-default.tex}
Larger space between elements in ancient notation.

Default: \unit[0.10938]{cm} plus \unit[0.01822]{cm} minus \unit[0.00911]{cm}

\macroname{\textbackslash clivisalignmentmin}{}{gsp-defualt.tex}
...
\macroname{\textbackslash clefchangespace}{}{gsp-default.tex}
...
The looseness within a score.

Default: \verb=\looseness=

\macroname{\textbackslash gretolerance}{}{gsp-default.tex}
The tolerance within a score.

Default: 9000

\macroname{\textbackslash grepretolerance}{}{gsp-default.tex}
The pretolerance within a score.

Default: $-1$ (Lua\TeX\ versions prior to 0.78) or \verb=\pretolerance= (all others)
