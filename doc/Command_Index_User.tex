...
A macro to change the behavior of the way gregoriotex includes scores.  This is similar to using the package options \verb=[forcecompile]=, \verb=[autocompile]=, and \verb=[nevercompile]=, but does not necessarly apply to the entire document.


\begin{argtable}
  \#1 & force & all later calls of \verb=\includescore= will compile the gabc
file into a gtex file.\\
  & auto & all later calls of \verb=\includescore= will use gregoriotex's
