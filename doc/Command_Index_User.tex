...
Reverts to the default behavior of \verb|\boxedgregorioscore|: use the
ambient \texttt{\textbackslash hsize} rather than a width set by
\verb|\gresetboxedscorewidth|.
