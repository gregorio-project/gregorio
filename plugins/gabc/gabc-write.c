...
write_score (FILE * f, gregorio_score * score)
{
  ...
  if (score->si.transcription_date)
    {
      fprintf (f, "transcription-date: %s;\n", score->si.transcription_date);
    }
