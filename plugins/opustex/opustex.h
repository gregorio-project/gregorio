/*
 * Gregorio OpusTeX headers. Copyright (C) 2007 Elie Roux
...
void opustex_print_liquescentia (FILE *f, char liquescentia, char glyph);

void opustex_print_augmentum_note (FILE *f, char pitch);

char
find_next_note (gregorio_element *current_element,
                gregorio_syllable *current_syllable);

char opustex_is_out_of_neume (gregorio_syllable *syllable);
