...
- Switch to TeXLive 2015 to build the docs (this is what the developers do when creating the distribution tar ball).
- Upgrade your `luaotfload` to the lastest master.
