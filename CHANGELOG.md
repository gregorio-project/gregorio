...
- Fixed vertical spacing so that rare signs (accentus, circulus, semicirculus, musica ficta) no longer collide with commentary or the above-lines nabc line, and so that below-lines nabc no longer collides with the low note it sits under. See [#1766](https://github.com/gregorio-project/gregorio/issues/1766).
