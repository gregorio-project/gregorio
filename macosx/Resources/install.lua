...
local texworksdir = kpse.expand_var("$TEXMFCONFIG"):gsub("/", "/")..'/texworks/'
...
function copy_files()
  ...
  texmfbin = texmfbin:gsub("/", "/").."/../bin/x86_64-darwin/"
...
local old_base_dirs = {
  ...
  texmflocal.."fonts/tfm/gregoriotex",
  texmflocal.."fonts/type1/gregoriotex",
